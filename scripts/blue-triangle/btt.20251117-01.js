  ...
  w._bttUtil = {
    ...
    pgSz: function (a) {
      ...
      try {
        ...
        for (var i in resTmg) {
          var encSz =
              resTmg[i].encodedBodySize != undefined
                ? resTmg[i].encodedBodySize
                : 0,
            decSz =
              resTmg[i].decodedBodySize != undefined
                ? resTmg[i].decodedBodySize
                : 0,
            init = resTmg[i].initiatorType;
          totalPgEncSize += encSz;
          totalPgDecSize += decSz;
          imgEncSize +=
            init === "img" || init === "image" || init === "icon" ? encSz : 0;
    ...
    fireBeacon: function (evt) {
      ...
      try {
        this.sVars = Object.assign(
          JSON.parse(this.curBeacon["SYSTEMVARS"]),
          this.sVars
        );
        this.curBeacon["SYSTEMVARS"] = this.rmEnc(JSON.stringify(this.sVars));
      } catch (e) {}
      try {
        this.cVars = Object.assign(
          JSON.parse(this.curBeacon["ECV"]),
          this.cVars
        );
    ...
    checkCVL: function () {
      ...
      if (
        PNM == "order-confirmation" ||
        PNM == "/checkout/starbucks" ||
        PNM == "/cart/payment/authorization/applePay" ||
        PNM == "/checkout" ||
        PNM == "/checkout/buyNow" ||
        PNM == "Android_OrderConfirmation" ||
        PNM == "Unnamed"
      ) {
        var CVL = 0,
          PGV = 0,
          ONumBr = 0;
        try {
          CVL = tgt.dataLayer.checkout.demand;
          if (CVL == 0 || CVL == undefined || CVL == "undefined" || CVL == "") {
            return;
          }
        } catch (e) {}
        try {
          ONumBr = tgt.dataLayer.checkout.orderId;
        ...
        var lastOVal = this.lclgt("targetinc3277321z-" + ONumBr);
        ...
        if (lastOVal == undefined || lastOVal == 0) {
          this.lclst("targetinc3277321z-" + ONumBr, CVL);
        }
      }
    },
    rmEnc: function (str) {
        ...
        try {
          for (; 9 !== t?.nodeType; ) {
            const n = t,
              o = n.id
                ? "#" + n.id
                : [i(n), ...Array.from(n.classList).sort()].join(".");
      ...
      g = (t, e, n = {}) => {
        try {
          if (PerformanceObserver.supportedEntryTypes.includes(t)) {
            ...
            return o.observe({ type: t, buffered: !0, ...n }), o;
          }
        } catch {}
      },
      p = (t) => {
    ...
    const v = () =>
      ...
      b = (t) => {
        "hidden" === document.visibilityState &&
          y > -1 &&
          ((y = "visibilitychange" === t.type ? t.timeStamp : 0), T());
      },
      M = () => {
      ...
      (t.onINP = (t, e = {}) => {
        ...
        const p = () => {
          ...
          y = () => {
            ...
            (i = i.filter((t, e) => (t.startTime > c && e > r) || o.has(t))),
              (h = !1);
          };
        (n.m = (t) => {
          ...
          n ||
            ...
            s.push(n)),
            (t.interactionId || "first-input" === t.entryType) && u.set(t, n),
            p();
        }),
          (n.p = (t) => {
            if (!l.get(t)) {
        ...
        const v = (t, e) => {
          ...
          b = (t) => {
            const e = t.entries[0],
              ...
              c = i.entries.sort(
                (t, e) => t.processingStart - e.processingStart
              ),
              d = v(e.startTime, a),
              ...
              for (const c of t.longAnimationFrameEntries) {
                ...
                for (const t of c.scripts) {
                  ...
                  const d = c - Math.max(e, t.startTime),
                    f = t.duration
                      ? (d / t.duration) * t.forcedStyleAndLayoutDuration
                      : 0;
                  (s += d - f),
                    (a += f),
                    d > u &&
            ...
            return Object.assign(t, { attribution: h });
          };
                ...
                const i = a(e, A),
                  r = (t) => {
                    W(() => {
                      ...
                      e &&
                        e.T !== o.value &&
                        ((o.value = e.T), (o.entries = e.entries), n());
                    });
                  },
                  s = g("event", r, {
                    durationThreshold: e.durationThreshold ?? 40,
                  });
                (n = f(t, o, q, e.reportAllChanges)),
                  s &&
          ...
          E(() => {
            ...
            if (c) {
              ...
              for (const t of ["keydown", "click", "visibilitychange"])
                addEventListener(t, () => W(n), { capture: !0, once: !0 });
              d((n) => {
                (i = m("LCP")),
                  (o = f(t, i, V, e.reportAllChanges)),
                  l(() => {
      ...
      (t.onTTFB = (t, e = {}) => {
        ((t, e = {}) => {
          ...
          R(() => {
            const r = n();
            r &&
              ((o.value = Math.max(r.responseStart - h(), 0)),
              (o.entries = [r]),
              i(!0),
              d(() => {
  ...
  w._bttWebVitals = {
    ...
    processCLS: function (metric) {
      ...
      _bttWebVitals.clsStart =
        metric.attribution?.largestShiftEntry?.startTime ?? "()";
    ...
    processINP: function (metric) {
      ...
      if (loafs && loafs.length > 0) {
        _bttWebVitals.inpLoafLongestScript = loafs.reduce(
    ...
    initLCPMetric: function () {
      try {
        var self = this;
        w._googleWebVitals.onLCP(self.processLCP, { reportAllChanges: true });
      } catch (e) {}
    },
    initCLSMetric: function () {
      try {
        var self = this;
        w._googleWebVitals.onCLS(self.processCLS, { reportAllChanges: true });
      } catch (e) {}
    },
    initINPMetric: function () {
      try {
        var self = this;
        w._googleWebVitals.onINP(self.processINP, { reportAllChanges: true });
      } catch (e) {}
    },
    initUserClickEvent: function () {
      try {
        document.addEventListener("click", function () {
          _bttUtil.sVars["userEventCount"] =
            (_bttUtil.sVars["userEventCount"] ?? 0) + 1;
        });
      } catch (e) {}
    },
    getTBT: function () {
    ...
    updateLCP: function (entry) {
      ...
      try {
        ...
        const reqS = Math.max(
          ttfb,
          resEnt ? resEnt.requestStart || resEnt.startTime : 0
        );
    ...
    updateFID: function (entry, po) {
      _bttWebVitals.fidDur = Math.round(
    ...
    estEvents: function (entry) {
      try {
        ...
        _bttWebVitals.minEvtID = Math.min(
          _bttWebVitals.minEvtID,
          entry.interactionId
        );
        _bttWebVitals.maxEvtID = Math.max(
          _bttWebVitals.maxEvtID,
          entry.interactionId
        );
        _bttWebVitals.eventCount = _bttWebVitals.maxEvtID
          ? (_bttWebVitals.maxEvtID - _bttWebVitals.minEvtID) / 7 + 1
          : 0;
      } catch (e) {}
    },
    updateINP: function (entry) {
      try {
        ...
        if (
          exInt ||
          _bttWebVitals.inpLil.length < 10 ||
          entry.duration > minLI.latency
        ) {
          if (exInt) {
    ...
    calcINP: function () {
      try {
        var intCount = window.performance.interactionCount
          ? window.performance.interactionCount
          : _bttWebVitals.eventCount;
        var candIdx = Math.min(
          _bttWebVitals.inpLil.length - 1,
          Math.floor(intCount / 50)
        );
    ...
    updateCWV: function () {
      ...
      try {
        _bU.sVars["navDur"] = Math.round(
          _bttWebVitals.navTimings.duration
        ).toString();
        _bU.sVars["navType"] = _bttWebVitals.navTimings.type;
        _bU.sVars["loadEventStart"] = Math.round(
          _bttWebVitals.navTimings.loadEventStart
        ).toString();
        _bU.sVars["loadEventEnd"] = Math.round(
          _bttWebVitals.navTimings.loadEventEnd
        ).toString();
      ...
      if (_bU.bttVT && _bU.curBeacon.hasOwnProperty("eventType")) {
        if (_bU.curBeacon["eventType"] == "5") {
          ...
          if (inpE && inpE != "") {
            VSCP["INPEventType"] = inpE.startsWith("key")
              ? "keyboard"
              : "pointer";
          }
        ...
        try {
          ...
          VSCP["CLSShiftLogShiftNumShiftValueShiftStartTimeShiftSourcesCount"] =
        ...
        try {
          ...
          VSCP["LCPElementRenderDelayPercentage"] =
            _bWV.getLCPElementRenderDelayPercentage();
          VSCP["LCPResourceLoadDelayMS"] = _bWV.getLCPResourceLoadDelayMS();
          VSCP["LCPResourceLoadDelayPercentage"] =
            _bWV.getLCPResourceLoadDelayPercentage();
          VSCP["LCPResourceLoadTimeMS"] = _bWV.getLCPResourceLoadTimeMS();
          VSCP["LCPResourceLoadTimePercentage"] =
            _bWV.getLCPResourceLoadTimePercentage();
          VSCP["LCPTimeToFirstByteMS"] = _bWV.getLCPTimeToFirstByteMS();
          VSCP["LCPTimeToFirstBytePercentage"] =
            _bWV.getLCPTimeToFirstBytePercentage();
        } catch (e) {}
        try {
          VSCP["LOAFLongestScriptDuration"] =
            _bWV.getLOAFLongestScriptDuration();
          VSCP["LOAFLongestScriptInvoker"] = _bWV.getLOAFLongestScriptInvoker();
          VSCP["LOAFLongestScriptSourceURL"] =
            _bWV.getLOAFLongestScriptSourceURL();
    ...
    getCLSLargestShiftStart: function () {
      const value =
        _bttWebVitals.clsMetric?.attribution?.largestShiftEntry?.startTime;
    ...
    getCLSShiftLogShiftNumShiftValueShiftStartTimeShiftSourcesCount:
      function () {
        if (
          !_bttWebVitals.clsMetric ||
          !_bttWebVitals.clsMetric.entries ||
          _bttWebVitals.clsMetric.entries.length == 0
        )
          return "()";
        let clsString = _bttWebVitals.clsMetric.entries.reduce(function (
          res,
          cls,
          i
        ) {
          return (
            res + `{${i},${cls.value},${cls.startTime},${cls.sources.length}}`
          );
        },
        "");
    ...
    getFIDTargetSelector: function () {
      function getSelector(el) {
        ...
        if (el.id) str += `#${el.id}`;
        if (el.className && typeof el.className.trim === "function")
          str += `.${el.className.trim().split(/\s+/).join(".")}`;
        if (str != "" && document.querySelectorAll(str).length == 1) return str;
        return getSelector(el.parentNode) + (str != "" ? ` > ${str}` : "");
      }
      if (
        _bttWebVitals.fidLog &&
        _bttWebVitals.fidLog.target &&
        _bttWebVitals.fidLog.target.outerHTML
      ) {
        let fidTargetCV = getSelector(_bttWebVitals.fidLog.target);
        if (fidTargetCV.length > 255) {
          fidTargetCV = fidTargetCV.substring(0, 256);
          fidTargetCV = result.substring(
            0,
            Math.max(
              [".", "#", " ", ">"].map((char) => fidTargetCV.lastIndexOf(char))
            )
          );
        }
        return fidTargetCV;
    ...
    getVTINPTargetSelector: function () {
      ...
      try {
        if (
          _bttWebVitals.inpLog &&
          _bttWebVitals.inpLog.target &&
          _bttWebVitals.inpLog.target.outerHTML
        ) {
    ...
    getLCPElementRenderDelayPercentage: function () {
      ...
      return typeof value === "number"
        ? Math.round((value * 100) / _bttWebVitals.lcpMetric.value).toString()
        : "()";
    },
    ...
    post: function (p) {
      try {
        ...
        var t = window._bttErr,
          jStr = "",
          url =
            "https://d.btttag.com/err.rcv?siteID=targetinc3277321z&nStart=" +
            p.nStart +
            "&pageName=" +
            p.pageName +
            "&txnName=" +
    ...
    capture: function (msg, url, lineNo, columnNo, error, errorType) {
      try {
        ...
        if (str.indexOf("script error") != -1) {
          var message = { msg: "Script error", url: url, eCnt: 1, time: t };
          _b.a.push(message);
          _b.b.push(message);
        } else {
...
(function () {
  (function () {
    var TO = new Date(),
      ...
      gCS = {},
      glbCmpMed = {},
      campSrcKey = "targetinc3277321z-campSource",
      campMedKey = "targetinc3277321z-campMedium";
    _BU.yyyydoy = yyyydoy;
    try {
      ...
      var siteCmpMed = [
        {
          mediumName: "Affiliate",
          referrerSearch: "",
          hrefSearch: "tgt_adv_xas",
          customCode: "",
        },
        {
          mediumName: "Affiliate",
          referrerSearch: "",
          hrefSearch: "campaign=AFL",
          customCode: "",
        },
        {
          mediumName: "Email",
          referrerSearch: "",
          hrefSearch: "tgt_email",
          customCode: "",
        },
        {
          mediumName: "Social Media Paid",
          referrerSearch: "",
          hrefSearch: "tgt_soc_pdl",
          customCode: "",
        },
        {
          mediumName: "Social Media Paid",
          referrerSearch: "",
          hrefSearch: "tgt_soc_pdp",
          customCode: "",
        },
        {
          mediumName: "Paid Search",
          referrerSearch: "",
          hrefSearch: "tgt_adv_xsl",
          customCode: "",
        },
        {
          mediumName: "Paid Search",
          referrerSearch: "",
          hrefSearch: "tgt_adv_xsb",
          customCode: "",
        },
        {
          mediumName: "Paid Search",
          referrerSearch: "",
          hrefSearch: "tgt_adv_xsp",
          customCode: "",
        },
        {
          mediumName: "Push Marketing",
          referrerSearch: "",
          hrefSearch: "tgt_xp",
          customCode: "",
        },
        {
          mediumName: "Paid Search",
          referrerSearch: "",
          hrefSearch: "campaign=PDS",
          customCode: "",
        },
        {
          mediumName: "SMS",
          referrerSearch: "",
          hrefSearch: "campaign=sms",
          customCode: "",
        },
        {
          mediumName: "DAV",
        ...
        },
        {
          mediumName: "Email Ops",
          referrerSearch: "",
          hrefSearch: "RedCardEmail",
          customCode: "",
        },
        {
          mediumName: "DAV",
          referrerSearch: "",
          hrefSearch: "campaign=DAV",
          customCode: "",
        },
        {
          mediumName: "Social Media Paid",
          referrerSearch: "",
          hrefSearch: "campaign=SMP",
          customCode: "",
        },
        {
          mediumName: "Unpaid Referrer",
          referrerSearch: "paypal.com",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Unpaid Referrer",
          referrerSearch: "affirm.com",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Push Ops",
          referrerSearch: "",
          hrefSearch: "campaign=POP",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "youtube",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "snapchat",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "tiktok",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "reddit",
          hrefSearch: "",
          customCode: "",
        },
        {
        ...
        {
          mediumName: "Social",
          referrerSearch: "tagged",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "dailymotion",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "blogspot",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "nextdoor",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "wordpress",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "cafemom",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "foursquare.com",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "yammer",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "buzzfeed",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "livejournal",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "retailmenot",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "goodreads",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "doubleclick",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "whatsapp",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "",
          hrefSearch: "tgt_soc_odl",
          customCode: "",
        },
        {
          mediumName: "Social",
          referrerSearch: "",
          hrefSearch: "tgt_soc_odp",
          customCode: "",
        },
        {
          mediumName: "Organic Search",
        ...
        {
          mediumName: "Organic Search",
          referrerSearch: "duckduckgo",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Organic Search",
          referrerSearch: "dogpile.com",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Organic Search",
          referrerSearch: "elle.com",
          hrefSearch: "",
          customCode: "",
        },
        {
        ...
        {
          mediumName: "Organic Search",
          referrerSearch: "rambler",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Organic Search",
          referrerSearch: "chatgpt",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Organic Search",
          referrerSearch: "perplexity",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Organic Search",
          referrerSearch: "gemini",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Organic Search",
          referrerSearch: "copilot",
          hrefSearch: "",
          customCode: "",
        },
        {
          mediumName: "Organic Search",
          referrerSearch: "",
          hrefSearch: "tgt_adv_xsf",
          customCode: "",
        },
        {
          mediumName: "Organic Search",
          referrerSearch: "",
          hrefSearch: "afid|||df_free",
          customCode: "",
        },
        {
          mediumName: "Unknown Channel",
          referrerSearch: "",
          hrefSearch: "ref|||utm_source",
          customCode: "",
        },
      ];
    } catch (e) {}
    ...
    if (CmpMJson == 0) {
      for (var src in glbCmpMed) {
        var refSrch,
          ...
          custCodeFlag = false;
        if (
          glbCmpMed[src].referrerSearch !== null &&
          glbCmpMed[src].referrerSearch != ""
        ) {
        ...
        if (
          glbCmpMed[src].hrefSearch !== null &&
          glbCmpMed[src].hrefSearch != ""
        ) {
        ...
        if (
          glbCmpMed[src].customCode !== null &&
          glbCmpMed[src].customCode != ""
        ) {
        ...
        if (
          typeof refSrch != "undefined" &&
          refSrch.indexOf("|||") === -1 &&
          document.referrer.indexOf(refSrch) != -1
        ) {
          refFlag = true;
        } else if (
          typeof refSrch != "undefined" &&
        ...
        if (
          typeof hrefSrch != "undefined" &&
          hrefSrch.indexOf("|||") === -1 &&
          window.location.href.indexOf(hrefSrch) != -1
        ) {
          hrefFlag = true;
        } else if (
          typeof hrefSrch != "undefined" &&
      ...
      for (var src in siteCmpMed) {
        var refSrch,
          ...
          custCodeFlag = false;
        if (
          siteCmpMed[src].referrerSearch !== null &&
          siteCmpMed[src].referrerSearch != ""
        ) {
          refSrch = siteCmpMed[src].referrerSearch;
        } else {
          refFlag = true;
        }
        if (
          siteCmpMed[src].hrefSearch !== null &&
          siteCmpMed[src].hrefSearch != ""
        ) {
          hrefSrch = siteCmpMed[src].hrefSearch;
        } else {
          hrefFlag = true;
        }
        if (
          siteCmpMed[src].customCode !== null &&
          siteCmpMed[src].customCode != ""
        ) {
          custCodeSrch = siteCmpMed[src].customCode;
        } else {
          custCodeFlag = true;
        }
        if (
        ...
        if (refFlag === true && hrefFlag === true && custCodeFlag === true) {
          CmpM = siteCmpMed[src].mediumName;
          if (typeof custCodeVal != "undefined") {
            CmpM = custCodeVal;
          }
          break;
    ...
    if (window.bttTag_Running == undefined) {
      ...
      try {
        document.addEventListener("visibilitychange", function checkCVL(evt) {
          if (
            evt.type === "pagehide" ||
            document.visibilityState === "hidden"
          ) {
            try {
              if (_bttUtil.tagVars["pageName"] == "order-confirmation") {
                _bttUtil.curBeacon["cartValue"] = tgt.dataLayer.checkout.demand;
                _bttUtil.curBeacon["ONumBr"] = tgt.dataLayer.checkout.orderId;
              }
            } catch (e) {}
          }
        });
        ...
        try {
          var pmetric =
            location.pathname.split("/")[1] == "p"
              ? tgt.bt.metrics.call_to_action
              : tgt.bt.metrics.soft_primary_content;
          if (pmetric === undefined) {
            pmetric = tgt.bt.metrics.hard_primary_content;
          }
          if (pmetric !== undefined) {
            _bttUtil.tti = pmetric;
            _bttUtil.curBeacon["tti"] = pmetric;
          }
        } catch (e) {}
        window.addEventListener("tgt.bt.metrics.update", function (event) {
          try {
            var pmetric =
              location.pathname.split("/")[1] == "p"
                ? tgt.bt.metrics.call_to_action
    ...
    function bttBeacon(tagEv) {
      ...
      NATIVEAPP = new Map();
      try {
        CV6 = tgt.bt.guest_onboardingGuest;
      } catch (err) {}
      try {
        CV7 =
          "base:" +
          tgt.bt.guest_target_membership.base_membership +
          ",card:" +
          tgt.bt.guest_target_membership.card_membership +
          ",paid:" +
          tgt.bt.guest_target_membership.paid_membership;
      } catch (err) {}
      try {
        CV8 = tgt.bt.guest_loggedIn;
      } catch (err) {}
      try {
        CV9 = tgt.bt.qualifiedExperiments.join(",");
      } catch (err) {}
      try {
        CV10 = tgt.bt.exposedExperiments.join(",");
      } catch (err) {}
      try {
        var cvt = (function () {
          try {
      ...
      try {
        var cvt = tgt.bt.guest_memberId;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV3", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.guest_visitor_id;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV4", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.page_layoutId;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV5", cvt);
      } catch (err) {}
      try {
        var cvt = (function () {
          if (location.pathname.split("/")[1] == "p") {
            return tgt.bt.metrics.call_to_action;
          } else {
            return tgt.bt.metrics.primary_content;
          }
        })();
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV6", cvt);
      ...
      try {
        var cvt = tgt.bt.metrics.call_to_action;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV7", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.metrics.primary_content;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV8", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.metrics.soft_primary_content;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV9", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.metrics.hard_primary_content;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV10", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.metrics.page_refresh;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV11", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.metrics.hard_page_refresh;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV12", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.metrics.soft_page_refresh;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV13", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.metrics.hydration;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV14", cvt);
      } catch (err) {}
      try {
        var cvt = tgt.bt.page_appBundleCacheStatus;
        cvt = _bttUtil.rmEnc(cvt.toString());
        ECV.set("CV15", cvt);
      } catch (err) {}
      try {
      ...
      try {
        var cvt = (function () {
          function getSelector(el) {
            ...
            if (str != "" && document.querySelectorAll(str).length == 1)
              return str;
            return getSelector(el.parentNode) + (str != "" ? " > " + str : "");
          }
      ...
      try {
        var cvt = (function () {
          ...
          if (
            window._bttWebVitals &&
            _bttWebVitals.clsLog &&
            _bttWebVitals.clsLog.length != 0
          ) {
      ...
      try {
        var cvt = (function () {
          ...
          for (i = 0; i <= _bttWebVitals.clsLog.length - 1; i++) {
            clsString =
              ...
              i +
              "," +
              _bttWebVitals.clsLog[i].value +
              "," +
              _bttWebVitals.clsLog[i].startTime +
              "," +
              _bttWebVitals.clsLog[i].sources.length +
              "}";
          }
          if (clsString.length > 255) {
            clsString = clsString.substring(0, 255);
        ...
        cvt = _bttUtil.rmEnc(cvt.toString());
        VITALSCOPE.set(
          "CLSShiftLogShiftNumShiftValueShiftStartTimeShiftSourcesCount",
          cvt
        );
      } catch (err) {}
      try {
      ...
      try {
        var cvt = (function () {
          ...
          if (
            window._bttWebVitals &&
            typeof _bttWebVitals.calcINP == "function"
          ) {
      ...
      try {
        var cvt = (function () {
          ...
          if (
            ...
            _bttWebVitals.lcpLog &&
            _bttWebVitals.lcpLog.SUB &&
            _bttWebVitals.lcpLog.SUB.length == 4
          ) {
      ...
      try {
        var cvt = (function () {
          ...
          if (
            window._bttWebVitals &&
            window._bttWebVitals.lcpLog &&
            window._bttWebVitals.lcpLog.ELE &&
            window._bttWebVitals.lcpLog.ELE.outerHTML
          ) {
      ...
      try {
        SYSTEMVARS.set(
          "navDur",
          Math.round(_bttWebVitals.navTimings.duration).toString()
        );
        SYSTEMVARS.set("navType", _bttWebVitals.navTimings.type);
        SYSTEMVARS.set(
          "loadEventStart",
          Math.round(_bttWebVitals.navTimings.loadEventStart).toString()
        );
        SYSTEMVARS.set(
          "loadEventEnd",
          Math.round(_bttWebVitals.navTimings.loadEventEnd).toString()
        );
      } catch (err) {}
      var PMs = [];
      if (Object.keys(_bttUtil.tagParm).length !== 0) {
      ...
      if (PMs[0] != "none") {
        ...
        (function (pname) {
          var BTT_URL =
            "https://d.btttag.com/analytics.rcv?pgNm=" +
            PMs[2] +
            "&trSeg=" +
            PMs[3] +
            "&navStart=" +
    ...
    function BG(eT) {
      ...
      var p22940 = undefined;
      try {
        if (
          typeof (function () {
            if (
              location.pathname.split("/")[1] == "s" &&
              typeof location.href.split("?")[1] == "undefined"
            ) {
              return "dl";
            } else if (
              location.pathname.split("/")[1] == "s" &&
              ...
              typeof location.pathname.split("/")[3] != "undefined" &&
              location.pathname.split("/")[1] != "p" &&
              location.pathname.split("/")[1] != "sp" &&
              location.pathname.split("/")[1] != "tracking" &&
              location.pathname.split("/")[1] != "pl" &&
              location.pathname.split("/")[1] != "sl" &&
              location.pathname.split("/")[3] != "-" &&
              location.pathname.split("/")[1] != "b" &&
              location.pathname.split("/")[1] != "c" &&
              location.pathname.split("/")[1] != "product" &&
              location.pathname.split("/")[2] != "pdp" &&
              ...
              location.pathname.split("/")[1] != "" &&
              typeof location.pathname.split("/")[1] != "undefined"
            ) {
      ...
      try {
        if (location.host.replace("www.", "") != undefined) {
          TxN = TxN + "-" + location.host.replace("www.", "");
        }
      } catch (err) {}
      try {
        if (location.href.split("?")[0] != undefined) {
          bttCamp = location.href.split("?")[0];
        }
      } catch (err) {}
      if (lclgt("targetinc3277321z-campaign", "json") != 0) {
        bttCamp = lclgt("targetinc3277321z-campaign", "json");
      }
      lclst(
        "targetinc3277321z-campaign",
        '{"value":"' + bttCamp + '","expires":"' + EXPs + '"}'
      );
      if (lclgt("targetinc3277321z-datacenter", "json") != 0) {
        DCTR = lclgt("targetinc3277321z-datacenter", "json");
      }
      if (DCTR != "Default") {
        lclst(
          "targetinc3277321z-datacenter",
          '{"value":"' + DCTR + '","expires":"' + EXPs + '"}'
        );
      }
      if (lclgt("targetinc3277321z-abtest", "json") != 0) {
        AB = lclgt("targetinc3277321z-abtest", "json");
      }
      if (AB != "Default") {
        lclst(
          "targetinc3277321z-abtest",
          '{"value":"' + AB + '","expires":"' + EXPs + '"}'
        );
      }
      try {
        if (
          ...
          try {
            if (tgt.dataLayer.checkout.demand != undefined) {
              CVL = tgt.dataLayer.checkout.demand;
            }
          } catch (err) {}
        } else {
          try {
            if (tgt.dataLayer.checkout.demand != undefined) {
              PGV = tgt.dataLayer.checkout.demand;
            }
          } catch (err) {}
        }
        try {
        ...
        try {
          if (tgt.bt.page_layoutId != undefined) {
            PTDB = tgt.bt.page_layoutId;
          }
        } catch (err) {}
        try {
          if (
            tgt.dataLayer.checkout.orderId != undefined &&
            parseFloat(CVL) > 0
          ) {
            ONumBr = tgt.dataLayer.checkout.orderId;
          }
      ...
      TxN =
        ruleNo == 0
          ...
          : encodeURIComponent(TxN + "|" + ruleNo.toString());
      ...
      if (_bttUtil.parmFlag) {
        if (GUIDC != 0) {
          if (CVL != 0) {
            var orderNum = lclgt("targetinc3277321z-" + ONumBr);
        ...
        if (typeof Storage !== "undefined") {
          lclst(GUID_N, GUIDC);
          if (lclgt("targetinc3277321z-" + ONumBr) == 0) {
            lclst("targetinc3277321z-" + ONumBr, CVL);
          }
        }
      }
      if (NTS == 1) {
        (nst = PT.navigationStart),
          (UST = PT.unloadEventStart),
          (RDS = PT.redirectStart),
          (RDs = RDS - nst),
          (RE = PT.redirectEnd),
          (RDe = RE - nst),
          (btt_FS = PT.fetchStart),
          (Fs = btt_FS - nst),
          (DST = PT.domainLookupStart),
          (DLs = DST - nst),
          (DSE = PT.domainLookupEnd),
          (DLe = DSE - nst),
          (CST = PT.connectStart),
          (CsT = CST - nst),
          (btt_CE = PT.connectEnd),
          (CeT = btt_CE - nst),
          (SCS = PT.secureConnectionStart || 0),
          (SCsT = SCS - nst),
          (RS = PT.requestStart),
          (RqT = RS - nst),
          (RES = PT.responseStart),
          (RsT = RES - nst),
          (REE = PT.responseEnd),
          (ReT = REE - nst),
          (dU = REE - nst);
        (DL = PT.domLoading),
          (DI = PT.domInteractive),
          (DLS = PT.domContentLoadedEventStart),
          (DLE = PT.domContentLoadedEventEnd),
          (DC = PT.domComplete),
          (LS = PT.loadEventStart),
          (LE = PT.loadEventEnd),
          (NT = 1),
          (RC =
            BTT_Perf != undefined && BTT_Perf.navigation != undefined
              ? BTT_Perf.navigation.redirectCount
              : 0),
          (totRD = LIM(RE - RDS)),
          (top = UST - LE),
          (dns = LIM(DSE - DST)),
        ...
        params =
          ...
          "&eT=" +
          eT +
          "&siteID=targetinc3277321z&txnName=" +
          TxN +
          "&campaign=" +
          bttCamp +
          "&AB=" +
...
window.bttUT = {
  ...
  measure: function (name, startKey, endKey) {
    if (
      window.bttUT.timingObj.hasOwnProperty(endKey) &&
      window.bttUT.timingObj.hasOwnProperty(startKey) &&
      name != undefined
    ) {
      var duration =
        window.bttUT.timingObj[endKey] - window.bttUT.timingObj[startKey];
      window.bttUT.measuredMarksArray.push({ duration: duration, name: name });
    }
  },
  checkUT: function () {
    var pm;
  ...
  vtNaming: function (arg) {
    try {
      ...
      if (pageName != undefined && txnName != undefined) {
        return { pageName: pageName, txnName: txnName, pageGroup: pageGroup };
      } else {
        return {
          pageName: undefined,
          txnName: undefined,
  ...
  sendResPost: function (p, thisIndex) {
    try {
      ...
      var url =
        "https://d.btttag.com/wcdv02.rcv?siteID=targetinc3277321z&nStart=" +
        p.nStart +
        "&pageName=" +
        p.pageName +
        "&txnName=" +
      ...
      var RSi = [],
        c = 0;
      if (
        p.hasOwnProperty("fullPage") &&
        p.fullPage === "true" &&
        p.hasOwnProperty("bRes") &&
        thisIndex == 0
      ) {
        RSi[0] = {};
        for (var i in p.bRes) {
      ...
      var RSobj = { url: location.href, data: RSi };
  ...
  pTNaming: function (url) {
    ...
    if (pageName != undefined && txnName != undefined) {
      ...
      return { pageName: undefined, txnName: undefined, pageGroup: undefined };
    }
  },
    ...
    if (pageName && txnName) {
      ...
      if (captureResources === true) {
        if (this.getResIndex() != false) {
          this.resObj[txnName + "--" + pageName + pageGroup + key] =
            this.getResIndex();
        }
      }
      try {
        if (window.bttUT.checkUT()) {
          performance.mark(
            txnName + "--" + pageName + pageGroup + key + "--start"
          );
        } else {
          window.bttUT.mark(
            txnName + "--" + pageName + pageGroup + key + "--start"
  ...
  update: function (arg) {
    ...
    if (pageName && txnName && type) {
      ...
      try {
        if (window.bttUT.checkUT()) {
          performance.mark(
            txnName + "--" + pageName + pageGroup + key + "--" + type
          );
        } else {
          window.bttUT.mark(
            txnName + "--" + pageName + pageGroup + key + "--" + type
    ...
    if (pageName == "order-confirmation-soft") {
      try {
        if (tgt.dataLayer.checkout.demand != undefined) {
          CVL = tgt.dataLayer.checkout.demand;
        }
    ...
    if (pageName && txnName) {
      ...
      try {
        if (arg.hasOwnProperty("uniqueKey") && arg.uniqueKey.length > 0) {
          ...
          if (window.bttUT.checkUT()) {
            performance.mark(
              txnName + "--" + pageName + pageGroup + key + "--end"
            );
          } else {
            window.bttUT.mark(
              txnName + "--" + pageName + pageGroup + key + "--end"
  ...
  bttMeasure: function (
    ...
    if (
      typeof optionalArgs != "undefined" &&
      optionalArgs.hasOwnProperty("uniqueKey")
    ) {
    ...
    if (this.checkUT()) {
      ...
      try {
        performance.measure(
          measureKey + "--domContentLoaded",
          measureKey + "--start",
          measureKey + "--domContLoaded"
        );
      } catch (e) {}
      try {
        if (
          window.bttUT.checkMark(measureKey + "--start") &&
          window.bttUT.checkMark(measureKey + "--end")
        ) {
          performance.measure(
            measureKey,
            measureKey + "--start",
    ...
    if (window.bttUT.lclgt("targetinc3277321z-campaign", "json") != 0) {
      bttCamp = window.bttUT.lclgt("targetinc3277321z-campaign", "json");
    }
    var thisEXPs = new Date().getTime() + 1800000;
    window.bttUT.lclst(
      "targetinc3277321z-campaign",
      '{"value":"' + bttCamp + '","expires":"' + thisEXPs + '"}'
    );
    if (window.bttUT.lclgt("targetinc3277321z-datacenter", "json") != 0) {
      DCTR = window.bttUT.lclgt("targetinc3277321z-datacenter", "json");
    }
    window.bttUT.lclst(
      "targetinc3277321z-datacenter",
      '{"value":"' + DCTR + '","expires":"' + thisEXPs + '"}'
    );
    if (window.bttUT.lclgt("targetinc3277321z-abtest", "json") != 0) {
      AB = window.bttUT.lclgt("targetinc3277321z-abtest", "json");
    }
    if (AB != "Default") {
      window.bttUT.lclst(
        "targetinc3277321z-abtest",
        '{"value":"' + AB + '","expires":"' + thisEXPs + '"}'
      );
    }
    var pageName = name;
    var txnName = txn;
    var siteID = "targetinc3277321z";
    if (pageName == "order-confirmation-soft") {
      try {
        if (tgt.dataLayer.checkout.demand != undefined) {
          cartVal = tgt.dataLayer.checkout.demand;
        }
      } catch (err) {}
    } else {
      try {
        if (tgt.dataLayer.checkout.demand != undefined) {
          pageVal = tgt.dataLayer.checkout.demand;
        }
      } catch (err) {}
    }
    ...
    var orders = 0;
    try {
      if (tgt.dataLayer.checkout.orderId != undefined && parseFloat(CVL) > 0) {
        ONumBr = tgt.dataLayer.checkout.orderId;
      }
    } catch (e) {}
    var currencyCode = "";
    ...
    var bttssI =
      "undefined" != typeof window.BTTtag_ssI ? window.BTTtag_ssI : "22222222";
    var TO = new Date(),
      start = new Date(TO.getFullYear(), 0, 0),
      diff = TO - start,
      doy = Math.floor(diff / 86400000),
    ...
    try {
      ...
      if (CVL != 0) {
        var orderNum = window.bttUT.lclgt("targetinc3277321z-" + ONumBr);
        if (ONumBr != 0 && orderNum != 0 && orderNum == CVL) {
          PGV = CVL;
          CVL = 0;
        } else if (ONumBr == 0 && CVL > 0 && CVL == LPurV && doy_diff < 3) {
      ...
      if (typeof Storage !== "undefined") {
        ...
        if (window.bttUT.lclgt("targetinc3277321z-" + ONumBr) == 0) {
          window.bttUT.lclst("targetinc3277321z-" + ONumBr, CVL);
        }
      }
    } catch (e) {
      console.log(20 + " " + e);
...
if (window._bttMgcCntr == 0) {
  ...
  XMLHttpRequest.prototype.send = function () {
    ...
    try {
      ...
      if (
        vtStartObj.pageName !== undefined &&
        vtStartObj.txnName !== undefined
      ) {
        window.bttUT.start({
      ...
      this.onreadystatechange = function () {
        ...
        if (this.readyState == 4 && this.status >= 200 && this.status < 300) {
          ...
          if (
            vtEndObj.pageName !== undefined &&
            vtEndObj.txnName !== undefined
          ) {
            window.bttUT.end({
          ...
          if (
            this.hasOwnProperty("pageName") &&
            this.hasOwnProperty("txnName") &&
            this.hasOwnProperty("bttStartKey")
          ) {
            var url = this.responseURL;
    ...
    fetch = function (url, opt) {
      ...
      try {
        ...
        if (
          ...
          opt.hasOwnProperty("method") &&
          opt.method.toLowerCase() === "post" &&
          opt.hasOwnProperty("body")
        ) {
      ...
      return promise.then(
        function (response) {
          if (response.status >= 200 && response.status < 300) {
            if (
              typeof f_pageName != "undefined" &&
              typeof f_txnName != "undefined" &&
              typeof f_bttStartKey != "undefined"
            ) {
              window.bttUT.end({
                pageName: f_pageName,
            ...
            try {
              var method = opt.hasOwnProperty("method")
                ? opt["method"] + " "
                : "";
              var msg =
                method +
...
(function (w) {
  ...
  try {
    var obs,
      ...
      conf = { attributes: true, childList: true, subtree: true },
      _BF = w._bttFPS,
      _BU = w._bttUtil;
    var _bttTmpProp = Event.prototype.stopPropagation;
    Event.prototype.stopPropagation = function () {
      _bttTmpProp.apply(this, arguments);
      var e = this;
      try {
    ...
    var callback = function (mutArr, obs) {
      setTimeout(
        function (mutArr, obs) {
          var t,
            nvSt,
            ...
            rstSess = 0;
          try {
            if (!!document.querySelector("div#pdp")) {
              end = +new Date();
              t = end - start;
              pgNm = "pdp-vt";
              pgGrp = "Virtual Turns";
              ...
              bypass = true;
              autoTimer = 0;
              (nvSt = start), (ldEvtSt = end);
              start = end = void 0;
              rstSess = 0;
              endingUrl = location.href;
              clearTimeout(qw);
            } else {
              end = +new Date();
              t = end - start;
          ...
          qw = setTimeout(
            function (t, nvSt, ldEvtSt, pgNm, txn, pgGrp, bypass, autoTimer) {
              if (
                !isNaN(t) &&
                t > 10 &&
                bypass != undefined &&
                ((startingUrl != endingUrl && autoTimer == 0) ||
                  (acStartUrl != endingUrl && autoTimer > 0))
              ) {
                if (endingUrl === "") {
                  acStartUrl = startingUrl = location.href;
                } else {
                  acStartUrl = startingUrl = endingUrl;
                }
                if (autoTimer > 0) {
                  end = start = void 0;
                }
                      ...
                      if (_bt.rdy === 1) {
                        ...
                        if (autoTimer > 0) {
                            ...
                            if (
                              (function () {
                                if (
                                  ...
                                  location.pathname.split("/")[3] != "" &&
                                  typeof location.pathname.split("/")[3] !=
                                    "undefined" &&
                                  location.pathname.split("/")[1] != "p" &&
                                  location.pathname.split("/")[1] != "sp" &&
                                  location.pathname.split("/")[1] !=
                                  ...
                                  location.pathname.split("/")[2] != "" &&
                                  typeof location.pathname.split("/")[2] !=
                                    "undefined" &&
                                  location.pathname.split("/")[1] != "p" &&
                                  location.pathname.split("/")[1] != "sp" &&
                                  location.pathname.split("/")[1] != "sl" &&
                                  ...
                                  location.pathname.split("/")[1] != "" &&
                                  typeof location.pathname.split("/")[1] !=
                                    "undefined"
                                ) {
                                  return (
                                    location.pathname.split("/")[1] + "-soft"
                                  );
                                } else {
                                  return "home-soft";
                                }
                          ...
                          try {
                            if (
                              (function () {
                                return tgt.bt.page_layoutId + " - MO";
                              })() != undefined
                            ) {
                              pgGrp = (function () {
                                return tgt.bt.page_layoutId + " - MO";
                        ...
                        try {
                          var cvt = (function () {
                            function getSelector(el) {
                              ...
                              if (
                                str != "" &&
                                document.querySelectorAll(str).length == 1
                              )
                                return str;
                              return (
                                getSelector(el.parentNode) +
                                (str != "" ? " > " + str : "")
                              );
                            }
                            function getTarget(entries) {
                              ...
                              if (
                                lrgEnt &&
                                lrgEnt.sources &&
                                lrgEnt.sources.length
                              ) {
                                var lrgSrc = lrgEnt.sources.reduce(function (
                                  a,
                                  b
                                ) {
                                  return a.node &&
                                    a.previousRect.width *
                                      a.previousRect.height >
                                      b.previousRect.width *
                                        b.previousRect.height
                                    ? a
                                    : b;
                                });
                                if (lrgSrc && lrgSrc.node) {
                        ...
                        try {
                          var cvt = (function () {
                            function getCLSLargestShiftTime(entries) {
                              var largestEntry = entries.reduce(function (
                                a,
                                b
                              ) {
                                return a && a.value > b.value ? a : b;
                        ...
                        try {
                          var cvt = (function () {
                            ...
                            for (
                              i = 0;
                              i <= _bttWebVitals.clsLog.length - 1;
                              i++
                            ) {
                              clsString =
                                clsString +
                            ...
                            if (clsString.length > 255) {
                              clsString = clsString.substring(0, 255);
                              clsString = clsString.substring(
                                0,
                                clsString.lastIndexOf("}") + 1
                              );
                            }
                            return clsString;
                          })();
                        ...
                        try {
                          var cvt = (function () {
                            ...
                            if (
                              ...
                              let lcpURLCV = String(
                                window._bttWebVitals.lcpLog.URL
                              );
                              if (lcpURLCV.length > 255) {
                                lcpURLCV = lcpURLCV.substring(0, 255);
                              }
                        ...
                        var nstDif = nvSt - _BU.WP.timing.navigationStart;
                        _BF.calcFps();
                        var lt_tti = 0;
                        var fps_tti =
                          _BU.ftti > 0 && _BU.ftti - nstDif > 0
                            ? _BU.ftti - nstDif
                            : 0;
                        var tti = fps_tti;
                        var rArgs = {
                          sessionID: _bt.sessionID,
                          guid: _bt.guid,
                          campaign: _bt.campaign,
                          txnName: _bt.txnName,
                        };
                        var oArgs = {
                          pageGroup: pgGrp,
                          datacenter: _bt.datacenter,
                          abtesting: _bt.abtesting,
                          CmpM: _bt.CmpM,
                          CmpS: _bt.CmpS,
                          pgTm: t,
                          nvSt: nvSt,
                          ...
                          VITALSCOPE: VITALSCOPE,
                          BOTS: BOTS,
                          COOKIES: COOKIES,
                          NATIVEAPP: NATIVEAPP,
                          MUTOBS: true,
                        };
                        window.bttUT.sendGif(pgNm, rArgs, oArgs);
                      }
                    }, 500);
                  } catch (e) {}
                }
    ...
    obs.observe(node, conf);
    function s(onload) {
      _BF.startFps();
      start = onload
        ? window._bttUtil.WP.timing.navigationStart + 1
        : +new Date();
      if (typeof startingUrl == "undefined") {
        startingUrl = onload ? "" : location.href;
        acStartUrl = location.href;
      }
      if (window.bttUT.getResIndex() != false) {
        window.bttUT.resObj[start] = window.bttUT.getResIndex();
      }
      if (!window._bttUtil.bttVT) {
        window._bttUtil.bttVT = true;
        window.bttUT.rdy = 1;
        if (!onload && !window._bttUtil.landSent) {
          const vtEvent = new Event("bttVT");
          window.dispatchEvent(vtEvent);
        }
      }
