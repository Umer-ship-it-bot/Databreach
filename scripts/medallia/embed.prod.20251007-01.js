  ...
  if (!window.KAMPYLE_EMBED) {
    window.KAMPYLE_EMBED = {
      ...
      isSupported: function () {
        var trident =
          window.KAMPYLE_EMBED.getUserAgent().match(/Trident\/(\d+)/);
      ...
      getGenericLocation: function () {
        var genericLocation =
          location.protocol +
          "//" +
          "resources.digital-cloud.medallia.com/wdcus/235967/onsite/generic1759260352205.js";
    ...
    if (window.KAMPYLE_EMBED.isSupported()) {
      if (document.readyState === "complete") {
        ...
        window.KAMPYLE_EMBED.kampyleEventHandler(
          window,
          "load",
          window.KAMPYLE_EMBED.kampyleInit
        );
