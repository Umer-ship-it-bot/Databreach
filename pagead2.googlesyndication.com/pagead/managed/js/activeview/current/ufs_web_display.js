(function () {
  ...
  var Ca = function (a, b, c, d) {
    ...
    Da = function (a) {
      for (; a.A.u; )
        try {
          var b = a.oi(a.A);
          if (b) return (a.A.oc = !1), { value: b.value, done: !1 };
        } catch (c) {
  ...
  p("Promise", function (a) {
    ...
    e.prototype.Ud = function () {
      ...
      var h = this,
        k = !1;
      return { resolve: g(this.Bi), reject: g(this.Fe) };
    };
    e.prototype.Bi = function (g) {
      if (g === this) this.Fe(new TypeError("i"));
    ...
    e.prototype.Ai = function (g) {
      ...
      typeof h == "function" ? this.Hi(h, g) : this.Cf(g);
    };
    e.prototype.Fe = function (g) {
      this.tg(2, g);
    };
    e.prototype.Cf = function (g) {
      this.tg(1, g);
    };
    ...
    e.prototype.rh = function () {
      if (this.Mb != null) {
        for (var g = 0; g < this.Mb.length; ++g) f.jf(this.Mb[g]);
        this.Mb = null;
      }
    };
    var f = new b();
    ...
    e.prototype.Tc = function (g, h) {
      ...
      var l = this;
      this.Mb == null ? f.jf(k) : this.Mb.push(k);
      this.bg = !0;
    };
    e.resolve = c;
    e.reject = function (g) {
  ...
  p("WeakMap", function (a) {
    ...
    h.prototype.delete = function (k) {
      return c(k) && sa(k, f) && sa(k[f], this.kc) ? delete k[f][this.kc] : !1;
    };
    return h;
  });
  p("Map", function (a) {
  ...
  Wa.prototype.flush = function () {
    if (!this.se) {
      ...
      try {
        for (
          ;
          Object.values(this.za).some(function (a) {
            return a.length > 0;
          });
        ...
        throw (
          (Object.values(this.za).forEach(function (b) {
...
*/
  ...
  var Kb = Array.prototype.forEach
      ? function (a, b) {
          D(a.length != null);
      ...
      if (b) {
        ...
        if (a) {
          ...
          if (e.Uc > 0) {
            ...
            e.sf = f;
            e.Xf
              ? ((e = e.G[f]), e.reset(d, c, b), (b = e))
              : ((e.Xf = f == e.Uc - 1), (b = e.G[f] = new $b(d, c, b)));
          } else b = new $b(d, c, b);
          cc(a, b);
        }
      }
...
*/
      ...
      if (e)
        for (this.Wb = null, b = y(e), c = b.next(); !c.done; c = b.next()) {
          ...
          try {
            ...
            (c = void 0),
              (d = (c = d) != null ? c : []),
              f instanceof nc ? (d = [].concat(z(d), z(f.errors))) : d.push(f);
          }
        }
      if (d) throw new nc(d);
    }
  ...
  function rc(a) {
    return (
      a instanceof pc ||
      (a && "closed" in a && I(a.remove) && I(a.add) && I(a.unsubscribe))
    );
  }
  var sc = function () {
  ...
  var vc = function (a) {
    ...
    this.destination =
      a instanceof vc
        ? a
        : new wc(!a || I(a) ? { next: a != null ? a : void 0 } : a);
    rc(a) && a.add(this);
  };
  q(vc, pc);
  vc.EMPTY = pc.EMPTY;
  ...
  n.subscribe = function (a, b, c) {
    a =
      (a && a instanceof vc) ||
      (a && I(a.next) && I(a.error) && I(a.complete) && rc(a))
        ? a
        : new xc(a, b, c);
    b = this.operator;
    c = this.source;
  ...
  function Rc(a, b) {
    if (a != null) {
      ...
      if (
        ...
        I(a == null ? void 0 : a[Symbol.asyncIterator])
      )
        return Jc(a, b);
  ...
  ed.prototype.Ba = function (a) {
    ...
    fd(this);
    for (
      var b = this.ef(a), c = this.le, d = this.buffer.slice(), e = 0;
      e < d.length && !a.closed;
      e += c ? 1 : 2
    )
      a.next(d[e]);
  ...
  function ld(a) {
    return function (b) {
      if (I(b == null ? void 0 : b.nb))
        return b.nb(function (c) {
          try {
            return a(c, this);
          } catch (d) {
            this.error(d);
  ...
  q(nd, K);
  nd.create = K.create;
  nd.prototype.Ba = function (a) {
    return od(this).subscribe(a);
  };
  var od = function (a) {
    var b = a.Pc;
    if (!b || b.S) a.Pc = a.vg();
  ...
  function zd(a) {
    if (a.length === 1) {
      var b = a[0];
      if (ud(b)) return { args: b, keys: null };
      if (b && typeof b === "object" && wd(b) === xd)
        return (
          (a = yd(b)),
          {
      ...
      k = function (l) {
        ...
        Tc(c(l, g++)).subscribe(
          new kd(
            ...
            function () {
              f--;
              for (var m = {}; e.length && f < d; m = { mf: void 0 })
                (m.mf = e.shift()), k(m.mf);
  ...
  function Md(a, b, c) {
    ...
    d = y(
      I(a.addEventListener) && I(a.removeEventListener)
        ? Kd.map(function (g) {
            return function (h) {
              return a[g](b, h, c);
            };
          })
        : I(a.addListener) && I(a.removeListener)
        ? Jd.map(Nd(a, b))
        : I(a.Zj) && I(a.Mj)
        ? Ld.map(Nd(a, b))
        : []
  ...
  Qd.prototype.H = function (a, b) {
    ...
    this.pending = !0;
    this.delay = b;
    this.id = this.id || this.He(c, this.id, b);
    return this;
  };
  Qd.prototype.He = function (a, b, c) {
    c = c === void 0 ? 0 : c;
  ...
  Qd.prototype.execute = function (a, b) {
    ...
    this.pending = !1;
    if ((a = this.df(a, b))) return a;
    this.pending === !1 &&
      this.id != null &&
      (this.id = Rd(this, this.id, null));
  };
  ...
  Qd.prototype.unsubscribe = function () {
    if (!this.closed) {
      ...
      this.Ve = this.state = this.scheduler = null;
      this.pending = !1;
      oc(b, this);
  ...
  ae.prototype.He = function (a, b, c) {
    c = c === void 0 ? 0 : c;
    return (c != null && c > 0) || (c == null && this.delay > 0)
      ? Qd.prototype.He.call(this, a, b, c)
      : a.flush(this);
  };
  var be = function () {
  ...
  function re(a) {
    ...
    return (
      ...
      !((d = a.F) == null || !d.timestamp) &&
      typeof a.Z === "function" &&
      typeof a.ka === "function" &&
      typeof a.ra === "function" &&
      typeof a.map === "function" &&
      typeof a.ta === "function"
    );
  }
  ...
  var ze = { aj: "app", zj: "web" };
  var Ae = ["sessionStart", "sessionError", "sessionFinish"],
    Be = function (a, b) {
      this.ea = a;
      this.Cd = b;
      this.ready = !1;
    ...
    Ne = function (a) {
      for (
        ...
        a.ea.addEventListener(c.value, function (d) {
          Je(a, d);
        });
      Ke(
        a.ea,
      ...
      : ld(function (b, c) {
          var d = 0,
            ...
            f = function () {
              var g = !1;
              e = b.subscribe(
                new kd(c, void 0, void 0, function () {
                  ++d < a
                    ? e
  ...
  function lf(a, b, c) {
    var d = I(a) || b || c ? { next: a, error: b, complete: c } : a;
    return d
      ? ld(function (e, f) {
          e.subscribe(
            new kd(
  ...
  nf.prototype.ping = function () {
    var a = this,
      b = M.apply(null, z(B.apply(0, arguments))).g(
        Fd(function (c) {
          return of(a, c);
        }),
        bf(function (c) {
  ...
  tf.prototype.sendNow = function () {
    if (this.kd)
      if ((this.Vg.unsubscribe(), this.Ob.M(this.properties)))
        try {
  ...
  vf.prototype.Re = function (a, b) {
    this.completed ||
      (this.mode === 1 && a === 1
        ...
        ? ((this.mode = a),
          xf(this, this.m.now()),
          this.completed || (this.id = uf(this)))
        : this.mode === 0 &&
          a === 1 &&
          ((this.mode = a), this.clear(), xf(this, b)));
  };
  ...
  function Af(a) {
    ...
    delete b.timestamp;
    return { timestamp: new ue(a.timestamp, te), value: b };
  }
  function Bf(a) {
    return (
      a !== void 0 &&
  ...
  var Kf = function (a, b) {
        ...
        h
          ? ((g = g.adView),
            (g =
              ...
              (g.geometry === void 0 || Bf(g.geometry)) &&
              (g.onScreenGeometry === void 0 || Bf(g.onScreenGeometry))))
          : (g = !1);
      }
      g
        ? ((f = Af(f)),
    ...
    Ie(a.Ra, function (f) {
      d += f;
      d > 0 && f === 0 && c.next({ timestamp: a.m.now(), value: !1 });
    });
    var e = c.g(
      kf(function (f) {
        return f.value;
  ...
  var Yf = function (a) {
    ...
    Zf = function (a) {
      for (var b = y(Object.values(ze)), c = b.next(); !c.done; c = b.next()) {
        c = c.value;
        var d = {};
    ...
    cg(
      function () {
        throw new (Function.prototype.bind.apply(
          Error,
          [null, "Could not complete the test successfully - "].concat(z(a))
        ))();
      },
      function () {
  ...
  mg.prototype.M = function () {
    ...
    var b =
      (b = dg.omidVerificationProperties) && b.injectionSource
        ? b.injectionSource
        : void 0;
    return (b || Zf(a) || Zf(fg(a) ? a.top : dg)) !== "web" || this.nc
      ? !(!this.bc && !this.yc)
      : !1;
  };
  var Ke = function (a, b, c) {
    Pf(b);
    a.yc
      ? a.yc.registerSessionObserver(b, c, a.nc)
      : a.Rb("addSessionListener", b, c, a.nc);
  };
  mg.prototype.addEventListener = function (a, b) {
    Of("eventType", a);
    Pf(b);
    this.yc
      ? this.yc.addEventListener(a, b, this.nc)
      : this.Rb("addEventListener", b, a, this.nc);
  };
  ...
  if (
    ...
    rg.slice(0, rg.length - 1).reduce($f, qg)[rg[rg.length - 1]] = mg;
  }
  function sg(a, b) {
    return function (c) {
      return new K(function (d) {
  ...
  ea.Object.defineProperties(ug.prototype, {
    timeline: {
      configurable: !0,
      enumerable: !0,
      get: function () {
  ...
  n.ha = function () {
    return (
      !!this.N.clearTimeout &&
      "setTimeout" in this.N &&
      "setInterval" in this.N &&
      !!this.N.clearInterval
    );
  };
  var yg = function (a, b) {
    xg.call(this, a, b);
  ...
  Hg.prototype.ping = function () {
    ...
    return Td.apply(
      null,
      z(
        B.apply(0, arguments).map(function (b) {
          return Sc(
  ...
  function Tg() {
    return Mg ? !!Qg && Qg.brands.length > 0 : !1;
  }
  function Ug() {
    return Tg() ? !1 : U("Opera");
  }
  ...
  var $g = function () {
      return Mg && Qg
        ? Qg.mobile
        : !Zg() && (U("iPod") || U("iPhone") || U("Android") || U("IEMobile"));
    },
    Zg = function () {
      return Mg && Qg
  ...
  function ih(a, b) {
    ...
    kh(b, a, d) ||
      lh.apply(
        null,
        [void 0, c, "Guard " + b.ge().trim() + " failed:"].concat(
          z(d.reverse())
        )
      );
  }
  ...
  function kh(a, b, c) {
    ...
    d ||
      nh(c, function () {
        var e = "";
        e.length > 0 && (e += ": ");
        return e + "Expected " + a.ge().trim() + ", got " + gh(b);
      });
    return d;
  }
  function nh(a, b) {
  ...
  var zh = function (a) {
      return a ? new xh(yh(a)) : zb || (zb = new xh());
    },
    Ah = function (a) {
  ...
  function Mh(a) {
    return function (b) {
      return b.g(Nh(a, ef(new L())));
    };
  }
  function V(a, b) {
    return function (c) {
      return c.g(Nh(a, ff(b)));
    };
  }
  function Nh(a, b) {
    function c(d) {
  ...
  var Qh = {},
    Rh = null,
    Sh = eh || fh || typeof Oa.btoa == "function",
    Uh = function (a) {
      var b;
  ...
  ea.Object.defineProperties($h.prototype, {
    l: {
      configurable: !0,
      enumerable: !0,
      get: function () {
  ...
  var ai = ["FRAME", "IMG", "IFRAME"],
    bi = /^[01](px)?$/,
    ci = function () {
      this.Sh = this.gf = this.jg = this.rf = !1;
    },
    di = function () {
      var a = new ci();
      a.rf = !0;
  ...
  function ii(a, b) {
    ...
    if ((a = ei(a))) {
      ...
      var l = 0,
        ...
        r = (a = !1);
      k = {};
      for (var t = 0; t < g.length; k = { ld: void 0 }, t++) {
        var w = g[t];
        if (!fi(w, c.gf))
          if (((k.ld = w.tagName === "IMG"), gi(w, c.rf)))
            (a = !0), k.ld && (u = !0);
          else {
            l++;
            var v = (function (x) {
  ...
  var qi = function (a, b) {
      ...
      this.global = a;
      this.rd = b;
      this.li = this.document
        ? Td(M(!0), Md(this.document, "visibilitychange")).g(
            sg(this.rd.I, 748),
            N(function () {
        ...
        : M("visible");
      this.ii = this.document
        ? Md(this.document, "DOMContentLoaded").g(sg(this.rd.I, 739), Ve(1))
        : M(Zh("DOMContentLoaded"));
    },
    ri = function (a) {
  ...
  var ti = function (a, b, c) {
      c = c === void 0 ? !1 : c;
      if (b.l === void 0 || !a.document) return M(b).g(sg(a.rd.I, 749));
      var d = new ed(1),
        e = function () {
          d.next(b);
        };
  ...
  ea.Object.defineProperties(qi.prototype, {
    document: {
      configurable: !0,
      enumerable: !0,
      get: function () {
        return Jg(this.global, "document")
  ...
  var Di = void 0,
    Ei,
    Fi,
    Gi = typeof TextDecoder !== "undefined",
    Hi,
    Ii = typeof String.prototype.isWellFormed === "function",
    Ji = typeof TextEncoder !== "undefined";
  var Ki = typeof Uint8Array !== "undefined",
    Li = !dh && typeof btoa === "function",
    Mi = /[-_.]/g,
    Pi = { "-": "+", _: "/", ".": "=" };
  function Qi(a) {
    return Pi[a] || "";
  ...
  function Ri(a) {
    if (!Li) return Wh(a);
    var b = Mi.test(a) ? a.replace(Mi, Qi) : a;
    try {
      var c = atob(b);
    } catch (d) {
      throw Error("V`" + a + "`" + d);
  ...
  function Wi(a) {
    ...
    var b = a.Lc;
    b == null ||
      (Ki && b != null && b instanceof Uint8Array) ||
      (typeof b === "string"
        ? (b = Ri(b))
        : (Db("Cannot coerce to Uint8Array: " + Qa(b)), (b = null)));
  ...
  function Yi(a, b) {
    ...
    if (a.constructor === ArrayBuffer)
      return (a = new Uint8Array(a)), new Xi(a, !1);
  ...
  var $i = typeof Oa.BigInt === "function" && typeof Oa.BigInt(0) === "bigint";
  function aj(a) {
    var b = a;
    if (qh(b)) {
  ...
  var gj = mh(function (a) {
      if ($i)
        return ih(bj, sh), ih(cj, sh), (a = BigInt(a)), a >= bj && a <= cj;
      ih(a, qh);
      return a[0] === "-" ? dj(a, ej) : dj(a, fj);
    }, "isSafeInt52"),
    ej = Number.MIN_SAFE_INTEGER.toString(),
    bj = $i ? BigInt(Number.MIN_SAFE_INTEGER) : void 0,
    fj = Number.MAX_SAFE_INTEGER.toString(),
    cj = $i ? BigInt(Number.MAX_SAFE_INTEGER) : void 0;
  function dj(a, b) {
  ...
  var hj = typeof Uint8Array.prototype.slice === "function",
    ij = 0,
    jj = 0,
    kj;
  function lj(a) {
  ...
  function oj(a) {
    D(a <= 8);
    return kj || (kj = new DataView(new ArrayBuffer(8)));
  }
  function pj(a, b) {
    var c = b * 4294967296 + (a >>> 0);
    return Number.isSafeInteger(c) ? c : qj(a, b);
  }
  function rj(a, b) {
    return aj(
      Zi()
  ...
  function wj(a) {
    D(a.length > 0);
    if (a.length < 16) mj(Number(a));
    else if (Zi())
      (a = BigInt(a)),
        (ij = Number(a & BigInt(4294967295)) >>> 0),
        (jj = Number((a >> BigInt(32)) & BigInt(4294967295)));
    else {
      D(a.length > 0);
      var b = +(a[0] === "-");
      jj = ij = 0;
      for (
        ...
        (d = Number(a.slice(d, e))),
          ...
          (ij = ij * 1e6 + d),
          ij >= 4294967296 &&
            ((jj += Math.trunc(ij / 4294967296)), (jj >>>= 0), (ij >>>= 0));
      b &&
        ((b = y(nj(ij, jj))),
        (a = b.next().value),
        (b = b.next().value),
  ...
  n.init = function (a, b, c, d) {
    ...
    this.Ad = e;
    a &&
      ((this.G = a = Yi(a, this.Ad)),
      (this.va = a.buffer),
      (this.Nd = a.Yf),
      (this.Ka = b || 0),
      (this.Ea = c !== void 0 ? this.Ka + c : this.va.length),
      (this.R = this.Ka));
  };
  n.ce = function () {
    this.clear();
  ...
  var Aj = function (a, b) {
    ...
    Ij = function (a, b) {
      ...
      var c = a.R,
        d = c + b;
      if (d > a.Ea) throw Error("da`" + (a.Ea - c) + "`" + b);
      a.R = d;
      return c;
    };
  xj.prototype.mg = function (a, b) {
    var c = Ij(this, a),
      d = D(this.va);
    if (Gi) {
      var e;
      b
        ? (e = Ei) || (e = Ei = new TextDecoder("utf-8", { fatal: !0 }))
        : (e = Fi) || (e = Fi = new TextDecoder("utf-8", { fatal: !1 }));
      var f = c + a;
      ...
      try {
        ...
        if (b) {
          if (Di === void 0) {
            ...
            try {
              e.decode(new Uint8Array([97])), (Di = !0);
            } catch (u) {
              Di = !1;
            }
          }
      ...
      for (var h = null, k, l; c < a; )
        (k = d[c++]),
          k < 128
            ...
            : Bi(b, g),
          g.length >= 8192 && ((h = Ci(h, g)), (g.length = 0));
      D(c === a, "expected " + c + " === " + a);
      g = Ci(h, g);
    }
    return g;
  };
  xj.prototype.Ee = function (a) {
  ...
  Kj.prototype.ce = function () {
    this.o.clear();
    this.j = this.Kb = this.qd = -1;
    Lj.length < 100 && Lj.push(this);
  };
  Kj.prototype.aa = function () {
    return this.o.aa();
  };
  ...
  Kj.prototype.advance = function (a) {
    this.o.advance(a);
  };
  var Nj = function (a) {
      var b = a.o;
    ...
    Oj = function (a) {
      switch (a.j) {
        case 0:
          a.j != 0
            ? (Db("Invalid wire type for skipVarintField"), Oj(a))
            : Gj(a.o);
          break;
        case 1:
          D(a.j === 1);
          ...
          break;
        case 2:
          if (a.j != 2) Db("Invalid wire type for skipDelimitedField"), Oj(a);
          else {
            var b = Cj(a.o);
            a.o.advance(b);
          }
    ...
    Pj = function (a, b, c) {
      ...
      var d = a.o.Ea,
        ...
        g = f - d;
      g <= 0 &&
        (a.o.setEnd(f), c(b, a, void 0, void 0, void 0), (g = f - a.o.aa()));
  ...
  var Wj = function (a, b, c) {
    ...
    Lj = [];
  var Xj = typeof Symbol === "function" && typeof Symbol() === "symbol";
  function Yj(a, b, c) {
  ...
  var Zj = Yj("jas", void 0, !0),
    ak = Yj("defaultInstance", "0di"),
    bk = Yj("unknownBinaryFields", Symbol()),
    ck = Yj("unknownBinaryThrottleKey", "0ub"),
    dk = Yj("unknownBinaryThrottleKey", "0ubs"),
    ek = Yj("unknownBinarySerializeBinaryThrottleKey", "0ubsb"),
    fk = Yj("m_m", "Jj", !0),
    gk = Yj("validPivotSelector", "vps"),
    hk = Yj("lazilyParseLateLoadedExtensions");
  D(
    Math.round(
      Math.log2(
        Math.max.apply(
  ...
  var ik = { Ih: { value: 0, configurable: !0, writable: !0, enumerable: !1 } },
  ...
  function Y(a, b, c) {
    (c === void 0 || !c || b & 2048) &&
      D(b & 64, "state for messages must be constructed");
    D(
      (b & 5) === 0,
  ...
  var uk = Object.getOwnPropertyDescriptor(Array.prototype, "Rh");
  ...
  var wk = Xj && Math.random() < 0.5,
    xk = wk ? Symbol() : void 0;
  function yk(a) {
    D(Z(a));
    return wk ? a[F(xk)] : a.B;
  }
  var zk,
    Ak = typeof fk === "symbol",
    Bk = {};
  ...
  function Ik(a) {
    ...
    (c = !b) ||
      (D(Z(a)),
      (a = wk ? a[F(xk)] : a.B),
      (c = G(a, "state is only maintained on arrays.")[X] | 0),
      Y(a, c),
      (c = !!(2 & c)));
    D(c);
    D(b === void 0 || b === Jk);
  ...
  function Xk(a, b, c) {
    if (a != null) {
      ...
      d = e[a] || 0;
      d >= b || ((e[a] = d + 1), (a = Error(c)), Sb(a, "incident"), Ph(a));
    }
  }
  function Yk(a) {
  ...
  function jl(a) {
    if (!bl(a))
      throw (
        ((a = "Expected enum as finite number but got " + Qa(a) + ": " + a),
        Wk(a))
      );
    return a | 0;
  }
    ...
    if (il(a)) {
      ...
      if (b === "number")
        return (
          ...
          D(!0),
          (a = cl(a)),
          al(a) || (D(!al(a)), D(Number.isInteger(a)), mj(a), (a = sj(ij, jj))),
          a
        );
    }
  }
  ...
  Bl.prototype.Va = function (a, b) {
    D(a == Math.floor(a));
    D(b == Math.floor(b));
    D(a >= 0 && a < 4294967296);
    for (D(b >= 0 && b < 4294967296); b > 0 || a > 127; )
      this.G.push((a & 127) | 128),
        (a = ((a >>> 7) | (b << 25)) >>> 0),
        (b >>>= 7);
    this.G.push(a);
  };
  Bl.prototype.af = function (a, b) {
    D(a == Math.floor(a));
    D(b == Math.floor(b));
    D(a >= 0 && a < 4294967296);
    D(b >= 0 && b < 4294967296);
  ...
  n.Ig = function (a, b) {
    b != null &&
      ...
      b != null && (Ll(a, b), Gl(this, a, 0), Dl(this.D, b)));
  };
  n.Jg = function (a, b) {
    if (b != null) {
      switch (typeof b) {
  ...
  n.Aa = function (a, b) {
    b != null &&
      ...
      b != null && (Gl(this, a, 0), Cl(this.D, b)));
  };
  n.Kg = function (a, b) {
    if (b != null) {
      switch (typeof b) {
  ...
  n.Ze = function (a, b) {
    b != null && (Gl(this, a, 5), this.D.Ze(b));
  };
  n.Ye = function (a, b) {
    b != null && (Gl(this, a, 1), this.D.Ye(b));
  };
  n.Xe = function (a, b) {
    b != null &&
  ...
  n.Dd = function (a, b) {
    b != null &&
      ((b = parseInt(b, 10)), Ll(a, b), Gl(this, a, 0), Dl(this.D, b));
  };
  n.af = function (a, b) {
    Gl(this, a, 1);
    this.D.af(b);
  ...
  function im(a, b, c) {
    ...
    d &&
      ...
      (a = yk(a)),
      G(a),
      (d = Ta(bk)) && d in a && (a = a[d]) && delete a[b]);
  }
  function jm(a, b) {
    D(Z(a));
    D(Z(a));
  ...
  function lm(a, b, c, d, e) {
      ...
      for (var x in r)
        (k = r[x]),
          k != null &&
            ...
            ((t = +x),
            (b = void 0),
            m && !Number.isNaN(t) && (b = Dk(t, F(u))) < h
              ? (nm(), (g[F(b)] = k))
              : ((t = void 0), (((t = e) != null ? t : (e = {}))[x] = k)));
    ...
    f &&
      ...
      G(a),
      D(g[bk] === void 0),
      (a = dm(a)) && a instanceof em && (g[bk] = gm(a)));
    return g;
  }
  function om(a) {
    F(a);
  ...
  function vm(a) {
    switch (typeof a) {
      ...
      case "object":
        return (
          G(a),
          D(a.length === 2 || (a.length === 3 && a[2] === !0)),
          D(a[0] == null || (typeof a[0] === "number" && a[0] >= 0)),
          D(a[1] == null || typeof a[1] === "string"),
          a
        );
    }
  }
  ...
  function xm(a, b, c, d) {
    ...
    if (a == null)
      ...
      if (!Array.isArray(a))
        throw Error("ya`" + JSON.stringify(a) + "`" + Qa(a));
      ...
      if (c && ((e |= 128), c !== a[0]))
        throw Error("Ca`" + c + "`" + JSON.stringify(a[0]) + "`" + Qa(a[0]));
      a: {
        c = a;
        e |= 64;
        var g = c.length;
        if (g) {
          ...
          if (f != null && typeof f === "object" && f.constructor === Object) {
            ...
            for (var k in f)
              (h = +k),
                h < g &&
                  ((h = Dk(h, b)), D(c[h] == null), (c[h] = f[k]), delete f[k]);
            e = sk(e, g);
            break a;
          }
        }
  ...
  function Gm(a, b) {
    if (b === void 0)
      (b = G(a, "state is only maintained on arrays.")[X] | 0), Y(a, b, !0);
    else {
      var c = G(a, "state is only maintained on arrays.")[X] | 0;
      Y(a, c, !0);
      D(b === c);
  ...
  var Im = function (a, b) {
    ...
    Hm = function (a, b, c, d) {
      ...
      if (b === -1) return null;
      var e = Ek(b, c);
      D(e === Dk(b, tk(G(a, "state is only maintained on arrays.")[X] | 0)));
      D(e >= 0);
      var f = a.length - 1;
      if (!(f < Ek(1, c))) {
        if (e >= f) {
  ...
  function Jm(a, b, c, d, e) {
    Tk(a, e);
    var f = Ek(c, e);
    D(f === Dk(c, tk(G(a, "state is only maintained on arrays.")[X] | 0)));
    D(f >= 0);
    var g = a.length - 1;
    if (g >= Ek(1, e) && f >= g) {
      var h = a[g];
  ...
  function Om(a, b, c) {
    ...
    D(d & 1);
    c || (D(Object.isFrozen(a) || d & 16), D(rk(b) ? Object.isFrozen(a) : !0));
  }
  function Pm(a, b, c, d, e) {
    ...
    d === 2 &&
      ...
      (D(Z(a)),
      (f = wk ? a[F(xk)] : a.B),
      (g = G(f, "state is only maintained on arrays.")[X] | 0),
      Y(f, g));
    a = Qm(f, b);
    var h = a === kk ? 7 : G(a, "state is only maintained on arrays.")[X] | 0,
      k = Rm(h, g);
    Pk(a);
    var l = 4 & k ? !1 : !0;
    if (l) {
      4 & k && ((a = Yk(a)), (h = 0), (k = Sm(k, g)), (g = F(Jm(f, g, b, a))));
  ...
  function Tm(a, b, c, d, e, f, g, h) {
    ...
    f === 1 || (f !== 4 ? 0 : 2 & b || (!(16 & b) && 32 & d))
      ...
      : (f === 2 &&
          Um(b) &&
          ((a = Yk(a)), (k = 0), (b = Sm(b, d)), (d = F(Jm(c, d, e, a)))),
  ...
  function Vm(a, b, c) {
    ...
    var d = Uk(b),
      e = Qm(a, c, d),
      f = e === kk ? 7 : G(e, "state is only maintained on arrays.")[X] | 0,
      g = Rm(f, b);
    if (2 & g || Um(g) || 16 & g)
      g === f || Um(g) || mk(e, g),
        (e = Yk(e)),
  ...
  var Wm = function (a, b, c) {
    ...
    var e = Uk(d),
      f = Hm(a, c, e);
    if (Ck(f)) {
      if (!Hk(f)) return Em(f), D(Z(f)), wk ? f[F(xk)] : f.B;
      D(Z(f));
      var g = wk ? f[F(xk)] : f.B;
  ...
  var Ym = function (a) {
    ...
    Zm = function (a, b, c, d) {
      ...
      if (!Hk(a, f)) {
        ...
        D(Z(g));
        var h = wk ? g[F(xk)] : g.B;
        var k = G(h, "state is only maintained on arrays.")[X] | 0;
        Y(h, k);
        g = Hk(g, k)
          ? Cm(g, h, k)
            ? Dm(g, h, !0)
        ...
        g !== b &&
          (Em(a) &&
            (D(Z(a)),
            (e = wk ? a[F(xk)] : a.B),
            (a = G(e, "state is only maintained on arrays.")[X] | 0),
            Y(e, a),
            (f = a)),
          (b = g),
          (f = Jm(e, f, c, b, d)),
    ...
    an = function (a) {
      ...
      var e = !!e || !1;
      a = Qm(c, 10);
      var f = a === kk ? 7 : G(a, "state is only maintained on arrays.")[X] | 0,
        g = Rm(f, d),
        h = !(4 & g);
      if (h) {
        var k = a,
    ...
    bn = function (a, b, c, d) {
      d != null ? tl(d, F(b)) : (d = void 0);
      Km(a, c, d);
      d && !Hk(d) && (D(Z(a)), (b = wk ? a[F(xk)] : a.B), Gm(b));
      return a;
    };
  function Sm(a, b) {
  ...
  var cn = function (a, b, c) {
    ...
    kn = function (a, b, c) {
      Fm(a);
      b = Pm(a, b, kl, 2, !0);
      b === kk || G(b, "state is only maintained on arrays.");
      if (Array.isArray(c))
        for (var d = c.length, e = 0; e < d; e++) b.push(jl(c[e]));
      else
        for (c = y(c), d = c.next(); !d.done; d = c.next()) b.push(jl(d.value));
      Pk(b);
      return a;
    };
  var ln = function (a, b, c) {
    this.preventPassingToStructuredClone = Nk;
    Jb(this, ln, "The message constructor should only be used by subclasses");
    D(
      this.constructor !== ln,
    ...
    D(Z(this));
    G(a);
    wk ? (this[F(xk)] = a) : (this.B = a);
    D(Z(this));
    a = wk ? this[F(xk)] : this.B;
    b = G(a, "state is only maintained on arrays.")[X] | 0;
    Y(a, b);
    D(b & 64);
    D(b & 2048);
  ...
  n.getExtension = function (a) {
    ...
    return a.cb
      ? a.md
        ? a.Bb(b, a.cb, a.ca, void 0 === Qk ? 2 : 4, a.hb)
        : a.Bb(b, a.cb, a.ca, a.hb)
      : a.md
      ? a.Bb(b, a.ca, void 0 === Qk ? 2 : 4, a.hb)
      : a.Bb(b, a.ca, a.defaultValue, a.hb);
  };
  n.hasExtension = function (a) {
    ...
    im(b, a.ca, a.we);
    a.cb
      ? (a = Mm(b, a.cb, a.ca, a.hb))
      : (D(!a.md, "repeated extensions don't support getExtensionOrUndefined"),
        Jb(b, a.Af),
        (b = Jb(b, ln)),
        jm(b, a.ca),
        im(b, a.ca, a.we),
        (a = a.cb ? a.Bb(b, a.cb, a.ca, a.hb) : a.Bb(b, a.ca, null, a.hb)),
  ...
  ln.prototype.toString = function () {
    D(Z(this));
    return (wk ? this[F(xk)] : this.B).toString();
  };
  ...
  var tn = nn(function (a, b, c, d, e) {
      if (a.j !== 2) return !1;
      Pj(a, Wm(b, d, c), e);
      return !0;
    }),
    un = nn(function (a, b, c, d, e) {
      if (a.j !== 2) return !1;
      Pj(a, Wm(b, d, c), e);
      return !0;
    }),
  ...
  function Cn(a, b, c, d) {
    ...
    for (k = 1; f !== void 0; ) {
      ...
      if ((f = m) == null ? 0 : f.Lg) {
        ...
        l = d;
        var u = g;
        typeof f === "function" && (D(f.length === 0), (f = f()), (l[u] = f));
        En(f);
        l = f;
      }
      f = d[++g];
  ...
  function Fn(a) {
    return Array.isArray(a)
      ? a[0] instanceof mn
        ? (D(a.length === 2), En(a[1]), a)
        : [un, En(a)]
      : [Jb(a, mn), void 0];
  }
  function sn(a, b) {
    if (a instanceof ln) return D(Z(a)), wk ? a[F(xk)] : a.B;
    if (Array.isArray(a)) return wm(a, b);
  }
  function Gn(a) {
    return Cn(wn, Hn, In, a);
  }
  function Hn(a, b, c, d) {
    var e = c.Ed;
    a[b] = d
  ...
  function In(a, b, c, d, e) {
    var f = c.Ed,
      ...
      h;
    a[b] = function (k, l, m) {
      return f(k, l, m, h || (h = Gn(d).wc), g || (g = Jn(d)), e);
    };
  }
  function Jn(a) {
    var b = a[xn];
      ...
      : function (d, e) {
          ...
          for (D(!(f & 2)); Nj(e) && e.j != 4; ) {
            ...
            if (g == null || !g(e, d, f)) {
              ...
              G(m);
              k &&
                ((g = (h = (l = m[bk]) != null ? l : (m[bk] = new em()))[f]) !=
                null
                  ? g
                  : (h[f] = [])
                ).push(k);
  ...
  function Nn(a, b, c, d) {
    var e,
      ...
      g = c.Fd;
    a[b] = function (h, k, l) {
      return g(h, k, l, f || (f = Cn(vn, Mn, Nn, d).wc), e || (e = On(d)));
    };
  }
  function On(a) {
    var b = a[yn];
  ...
  function Pn(a, b, c) {
    Sk(a, G(a, "state is only maintained on arrays.")[X] | 0, function (e, f) {
      if (f != null) {
        var g = Qn(c, e);
        g ? g(b, f, e) : (G(a), e < 500 || Xk(ek, 3, "0ubsb:" + e));
      }
    });
    var d = dm(a);
    d &&
  ...
  function Rn(a, b, c) {
    if (Array.isArray(b)) {
      ...
      for (var e = 0, f = 0; e < b.length; e++) {
        var g = a(b[e]);
        g != null &&
          (D(typeof g !== "object" || g instanceof Ui), (b[f++] = g));
      }
      f < e && (b.length = f);
      a = d | 1;
      c && (a = (a | 4) & -1537);
  ...
  function Un(a, b, c) {
    var d = G(a, "state is only maintained on arrays.")[X] | 0;
    Y(a, d, !0);
    Jm(a, d, b, c, Uk(G(a, "state is only maintained on arrays.")[X] | 0));
  }
  function Vn(a, b, c) {
  ...
  var Wn = Sn(
      ...
      function (a, b, c) {
        if (Og)
          return (
            a.j !== 0
              ? (b = !1)
              : (D(a.j == 0), (a = Aj(a.o, tj)), Un(b, c, a), (b = !0)),
            b
          );
        if (a.j !== 0) return !1;
        D(a.j == 0);
    ...
    Zn = Sn(
      function (a, b, c) {
        if (Og) return a.j !== 0 ? (a = !1) : (Un(b, c, Tj(a)), (a = !0)), a;
        if (a.j !== 0) return !1;
        Un(b, c, Sj(a));
        return !0;
      },
      ...
      function (a, b, c) {
        if (Og) {
          if (a.j !== 0 && a.j !== 2) a = !1;
            ...
            Y(b, d, !0);
            b = Vm(b, d, c);
            a.j == 2 ? Wj(a, Ej, b) : b.push(Tj(a));
            a = !0;
          }
          return a;
        }
        if (a.j !== 0 && a.j !== 2) return !1;
        d = G(b, "state is only maintained on arrays.")[X] | 0;
        Y(b, d, !0);
        b = Vm(b, d, c);
        a.j == 2 ? Wj(a, Dj, b) : b.push(Sj(a));
        return !0;
      },
      function (a, b, c) {
        b = Rn(rl, b, !1);
        ...
        if (b != null)
          for (var d = 0; d < b.length; d++) {
            var e = a,
              f = c,
              g = b[d];
            g != null && (Ll(f, g), Gl(e, f, 0), Dl(e.D, g));
          }
      },
      Rl
    ),
    co = Sn(
      ...
      function (a, b, c) {
        b = pl(b);
        b != null &&
          (Kl(c, b, b >= 0 && b < 4294967296), Gl(a, c, 5), a.D.Aa(b));
      },
      Tl
    ),
    eo = Sn(
        ...
        if (b != null) {
          ...
          if (Ji) {
            if (
              ...
              throw Error("U");
            b = (Hi || (Hi = new TextEncoder())).encode(b);
          } else {
            for (
  ...
  var io = Sn(
    ...
    jo = Tn(
      ...
      function (a, b, c) {
        ...
        if (b != null && b.length) {
          c = Hl(a, c);
          for (var d = 0; d < b.length; d++) Cl(a.D, b[d]);
          Il(a, c);
        }
      },
      Sl
    ...
    lo = Tn(
      ...
      function (a, b, c) {
        b = Rn(nl, b, !0);
        if (b != null) for (var d = 0; d < b.length; d++) a.Dd(c, b[d]);
      },
      Yl
    ),
    mo = Tn(
  ...
  po.prototype.register = function () {
    Ig(this);
  };
  function qo(a) {
    if (a instanceof ln) return a.constructor.V;
  }
  (function () {
    var a = Oa.jspbGetTypeName;
    Oa.jspbGetTypeName = a
      ? function (b) {
          return a(b) || qo(b);
        }
      : qo;
  ...
  function to(a) {
    return function () {
      var b = new El();
      Pn(yk(Jb(this, ln)), b, Cn(vn, Mn, Nn, a));
      Fl(b, b.D.end());
      for (
        var c = new Uint8Array(b.ub), d = b.Md, e = d.length, f = 0, g = 0;
        g < e;
        g++
      ) {
        var h = d[g];
  ...
  $m.V = "wireless.mdl.UserAgentClientHints.BrandAndVersion";
  var vo = [0, fo, -1];
  $m.prototype.O = to(vo);
  var wo = function (a) {
    ro.call(this, a);
  ...
  var xo = function (a, b) {
    ...
    Co = function (a, b) {
      ...
      if (b == null) Jm(d, e, 10);
        ...
        var f = b;
        if (!Array.isArray(f))
          throw ((a = "Expected array but got " + Qa(f) + ": " + f), Wk(a));
        for (
          var g = (f =
              b === kk
                ? 7
                : G(b, "state is only maintained on arrays.")[X] | 0),
            h = Um(f),
  ...
  wo.V = "wireless.mdl.UserAgentClientHints";
  wo.prototype.O = to([0, fo, -4, go, vo, eo, ko, fo, go, vo, eo]);
  var Go =
        ...
        Ao(
          xo(
            Eo(
              zo(
                Fo(
                  Bo(yo(new wo(), a.architecture || ""), a.bitness || ""),
                  a.mobile || !1
                ),
                a.model || ""
              ),
  ...
  var Mo = function (a, b, c, d) {
    ...
    this.m = new ug(new zg(this.N, this.I), new yg(this.N, this.I));
    this.J = new qe(
      new Dg(this),
      new Ih(this),
      new sf(this, new Hg(this)),
      new sf(this, new Lh(this)),
      new sf(this, new Gh(this))
    );
  };
  q(Mo, ce);
  var No = function (a) {
  ...
  Mo.prototype.validate = function () {
    ...
    return this.global && this.m.ha() && a;
  };
  var Yh = function (a) {
    return (a = Lo(a.global)) ? Sc(a) : null;
  };
  ...
  var To = {},
    Uo =
      ((To["data-google-av-cxn"] = "_avicxn_"),
      (To["data-google-av-cpmav"] = "_cvu_"),
      (To["data-google-av-metadata"] = "_avm_"),
      (To["data-google-av-adk"] = "_adk_"),
      (To["data-google-av-btr"] = void 0),
      (To["data-google-av-override"] = void 0),
      (To["data-google-av-dm"] = void 0),
      (To["data-google-av-immediate"] = void 0),
      (To["data-google-av-aid"] = void 0),
      (To["data-google-av-naid"] = void 0),
      (To["data-google-av-inapp"] = void 0),
      (To["data-google-av-slift"] = void 0),
      (To["data-google-av-itpl"] = void 0),
      (To["data-google-av-ext-cxn"] = void 0),
      (To["data-google-av-rs"] = void 0),
      (To["data-google-av-flags"] = void 0),
      (To["data-google-av-turtlex"] = void 0),
      (To["data-google-av-ufs-integrator-metadata"] = void 0),
      (To["data-google-av-vattr"] = void 0),
      (To["data-google-av-vrus"] = void 0),
      To),
    Vo = {},
    Wo =
      ((Vo["data-google-av-adk"] = "googleAvAdk"),
      (Vo["data-google-av-btr"] = "googleAvBtr"),
      (Vo["data-google-av-cpmav"] = "googleAvCpmav"),
      (Vo["data-google-av-dm"] = "googleAvDm"),
      (Vo["data-google-av-ext-cxn"] = "googleAvExtCxn"),
      (Vo["data-google-av-immediate"] = "googleAvImmediate"),
      (Vo["data-google-av-inapp"] = "googleAvInapp"),
      (Vo["data-google-av-itpl"] = "googleAvItpl"),
      (Vo["data-google-av-metadata"] = "googleAvMetadata"),
      (Vo["data-google-av-naid"] = "googleAvNaid"),
      (Vo["data-google-av-override"] = "googleAvOverride"),
      (Vo["data-google-av-rs"] = "googleAvRs"),
      (Vo["data-google-av-slift"] = "googleAvSlift"),
      (Vo["data-google-av-cxn"] = "googleAvCxn"),
      (Vo["data-google-av-aid"] = void 0),
      (Vo["data-google-av-flags"] = "googleAvFlags"),
      (Vo["data-google-av-turtlex"] = "googleAvTurtlex"),
      (Vo["data-google-av-ufs-integrator-metadata"] =
        "googleAvUfsIntegratorMetadata"),
      (Vo["data-google-av-vattr"] = "googleAvVattr"),
      (Vo["data-google-av-vrus"] = "googleAvVurs"),
      Vo);
  function Xo(a, b) {
  ...
  function dp(a) {
    ...
    var c;
    return (a = (c = a.l) == null ? void 0 : c.id)
  ...
  function hp(a, b) {
    b = b === void 0 ? Hc : b;
    return Td(cp(a), b).g(ap(), gp(), fp(), V(a.i, 1));
  }
  function ip(a, b) {
    return new K(function (c) {
      var d = !1,
  ...
  function jp(a, b, c) {
    function d() {
      if (b.Da) {
        ...
        P = {
          ...
          specMinor: 0,
          specPatch: 0,
          timestamp: we(b.m.now(), new ue(0, b.m.timeline)),
    ...
    return (u = u.length > 0) && a
      ? Td(M(Object.freeze(l)), t)
      : u
      ? t
      : M(Object.freeze(l));
  }
  function kp(a, b, c, d) {
    var e = lp(mp(np(), op), pp, qp);
    return a.I.Ub.bind(a.I)(733, function () {
      ...
      try {
        ...
        return d(Object.assign({}, f, { error: g })), Hc;
      }
    })();
  }
  function rp(a, b) {
  ...
  var pp = J(
    ...
    N(function (a) {
      a.lb ||
        a.Vb(a.ac, a).forEach(function (b) {
          a.J.K(b).sendNow();
        });
    }),
    Ve(1),
  ...
  var wp = J(
    ...
    N(function (a) {
      return Object.assign({}, a, { wd: sp(a) });
    }),
    N(function (a) {
      a.wb(
        Object.assign({}, a, { oa: a.jb, X: a.X, Ac: a.Gb, Mc: 3, Cc: "m" }),
        a.wd
      ).forEach(function (b) {
        a.J.K(b).sendNow();
      });
    ...
    return a.g(
      N(function (c) {
        ...
        if (v && e) {
          ...
          A.forEach(function (S, la) {
            la >= b.length ? b.push(d.K(P, { vf: !0 })) : (b[la].url = P);
          });
          return l !== void 0
            ? (A.forEach(function (S) {
                e.K(S).sendNow();
  ...
  function Dp(a, b) {
    var c = b.g(Bp(a, { attributes: !0 }), V(a.i, 1));
    return Ad([b, c.g(V(a.i, 1), Ap(a.i))]).g(
      N(function (d) {
        return y(d).next().value;
      }),
      Yo("data-google-av-dm"),
      N(Ep)
    );
  }
  function Ep(a) {
  ...
  function Lp(a, b) {
    return a.replace(Kp, function (c, d) {
      try {
        ...
        if (e == null)
          return lc("No value supplied for unsupported macro: " + d), c;
        if (e.toString() == null)
          return (
            lc("The toString method of value returns null for macro: " + d), c
          );
        e = e.toString();
  ...
  var xp = J(
    ...
    N(function (a) {
      ...
      c = a.wb(
        Object.assign({}, a, { oa: a.jb, X: a.X, Ac: a.Gb, Mc: 4, Cc: "v" }),
        a.wd
      );
      (d = a.Td) &&
        d.length > 0 &&
        a.Vb &&
        a.Vb(d, a).forEach(function (e) {
          b.K(e).sendNow();
        });
      (d = a.Te) &&
        d.length > 0 &&
    ...
    return e.reduce(function (h, k) {
      ...
      return Object.assign(
        ...
        ((l[k] = b.g(
          T(function (m) {
            return (m = m ? c[k] : d[k]) &&
              (m instanceof K || (I(m.nb) && I(m.subscribe)))
              ? m
              : m.T(a);
          })
        )),
  ...
  function Rp(a, b) {
    ...
    a.Ca = b;
    a.qb && a.qb.value
      ? ((b = Math.max(0, we(b.timestamp, a.qb.timestamp))),
        (a.totalTime += b),
        (a.qa += b))
      : (a.qa = 0);
    return a;
  ...
  var Vp = { Yi: "asmreq", Zi: "asmres" };
  var Wp = function (a) {
    ro.call(this, a);
  };
  q(Wp, ro);
  Wp.prototype.qg = function (a) {
    gn(this, 1, a);
  };
  Wp.V = "tagging.common.osd.AdSpeedMetricsRequest";
  Wp.prototype.O = to([0, io]);
  var Xp = function (a) {
    ro.call(this, a);
  };
  q(Xp, ro);
  ...
  var Yp = [0, ao, -3];
  Xp.prototype.O = to(Yp);
  var Zp = function (a) {
    ro.call(this, a);
  };
  q(Zp, ro);
  Zp.prototype.qg = function (a) {
    gn(this, 1, a);
  };
  var $p = uo(Zp);
  Zp.V = "tagging.common.osd.AdSpeedMetricsResponse";
  Zp.prototype.O = to([0, io, eo, Yp, ao, -1]);
  function aq(a, b) {
    ...
    b = b.g(
      ...
      lf(function (f) {
        var g = new Wp();
        g.qg(f);
        f = { type: "asmreq", payload: g.Ta() };
        c.postMessage(f, "*", [d.port2]);
      }),
      Ve(1)
    );
    var e = Po(a, d.port1).g(
      O(function (f) {
    ...
    hq = function (a, b) {
      b
        ? a.pe ||
          ...
          (a.pe = new IntersectionObserver(a.nf, b)))
        : a.ne || (a.ne = new IntersectionObserver(a.nf, a.options));
    },
    iq = function (a, b) {
      a = b ? a.pe : a.ne;
      if (!a) throw new je();
  ...
  gq.prototype.observe = function (a, b) {
    iq(this, a).observe(b);
  };
  gq.prototype.unobserve = function (a, b) {
    iq(this, a).unobserve(b);
  };
  gq.prototype.disconnect = function (a) {
    iq(this, a).disconnect();
  };
  gq.prototype.takeRecords = function (a) {
    return iq(this, a).takeRecords();
  };
  var jq = {
    fa: "ns",
    ja: wi,
          ...
          N(function (f) {
            ...
            if (f.l === void 0)
              ...
              var l = f.l,
                m = a.global,
                u = new vh(0, 0);
              var r = (r = yh(l)) ? r.defaultView : window;
              if (Jg(r, "parent")) {
                do {
                  if (r == m) {
                    var t = l,
                    ...
                    var v = new vh(0, 0);
                    var x = (w ? yh(w) : document).documentElement;
                    t != x &&
                      ((t = Eh(t)),
                      (w = zh(w)),
                      (w = Ah(w.hc)),
                      (v.x = t.left + w.x),
                      (v.y = t.top + w.y));
                  } else (v = D(l)), (v = Eh(v)), (v = new vh(v.left, v.top));
                  u.x += v.x;
                  u.y += v.y;
                } while (
                  r &&
            ...
            if (g !== 2 || a.lc || m.width <= 0 || m.height <= 0) var A = !1;
              ...
              try {
                var P = a.document.elementFromPoint(
                  m.left + m.width / 2,
                  m.top + m.height / 2
                );
                A = P ? !mq(P, f) : !1;
            ...
            return {
              timestamp: u,
              value: l.call(r, {}, h, { U: "geo", W: A ? jq.W : m, L: k }),
            };
          }),
          Mh(a.i)
        );
  ...
  function mq(a, b, c) {
    ...
    return a.l === void 0 || b.l === void 0
      ...
      ? !0
      : b.l.ownerDocument &&
        b.l.ownerDocument.defaultView &&
        b.l.ownerDocument.defaultView === b.l.ownerDocument.defaultView.top
      ? !1
      : c < 10 &&
        b.l.ownerDocument &&
        b.l.ownerDocument.defaultView &&
        b.l.ownerDocument.defaultView.frameElement
      ? mq(a, new $h(b.l.ownerDocument.defaultView.frameElement), c + 1)
      : !0;
  }
  function nq(a) {
    return function (b) {
      return b.g(a.ResizeObserver ? oq(a) : pq(a), ff(1), md());
    };
  }
  function oq(a) {
    return function (b) {
      return b.g(
        T(function (c) {
          ...
          var e = new K(function (f) {
            ...
            if (c.l === void 0) return f.complete(), function () {};
          ...
          return Td(M(c.l.getBoundingClientRect()), e);
        }),
        Q(xi)
      );
    };
      ...
      return function (e) {
        ...
        return Ad([c, e]).g(
          T(function (f) {
            ...
            f = g.next().value;
            g = g.next().value;
            return sq(a, f.Mh, nq(a), f.hi, d, f.wh, g);
          }),
          Mh(a.i)
        );
      };
      ...
      return function (g) {
        return Ad([g, f]).g(
          N(function (h) {
            ...
            h = k.next().value;
            k = k.next().value;
            var l = zi(k.value.L, h.value.pa),
              m = yi(zi(k.value.W, h.value.pa), h.value.ja);
            return {
              timestamp: h.timestamp.maximum(k.timestamp),
              value: Object.assign({}, h.value, { U: "nio", W: m, L: l }),
            };
          })
        );
      };
  ...
  function uq(a) {
    return N(function (b) {
      return b.value.fa !== "nio"
        ? b
        : Object.assign({}, b, {
            value: Object.assign({}, b.value, { ja: Qo(a, !0), Y: Qo(a, !0) }),
          });
    });
  }
  function vq(a, b) {
  ...
  function rq(a, b) {
    return a.m.timeline !== se
      ...
      ? typeof IntersectionObserver === "undefined"
        ...
        : new K(function (c) {
            var d = new L(),
              e = new gq(d.next.bind(d), { threshold: [].concat(z(b)) });
            c.next({
              hi: d.g(sg(a.I, 735)),
              Mh: e,
              wh: function (f) {
  ...
  function sq(a, b, c, d, e, f, g) {
    return new K(function (h) {
      ...
      if (g.l !== void 0) {
        ...
        var l = new Gc({
            timestamp: a.m.now(),
            value: Object.assign({}, jq, { fa: "nio", U: "nio" }),
          }),
          m = d
            .g(
              Fd(function (x) {
          ...
          r = u.subscribe(function () {
            f(e);
            h.next({ timestamp: a.m.now(), value: l.value.value });
            g.l !== void 0 && (b.unobserve(e, g.l), b.observe(e, g.l));
          }),
          t = vq(c, g).subscribe(function () {
            u.next();
          }),
          w = !1,
  ...
  Cq.prototype.Z = function (a) {
    return a instanceof Cq ? this.a.Z(a.a) && this.b.Z(a.b) : !1;
  };
  Cq.prototype.ra = function (a) {
    var b = this.a.ra(a).value,
      c = this.b.ra(a).value;
    return { timestamp: a, value: [b, c] };
  };
  ea.Object.defineProperties(Cq.prototype, {
    active: {
      configurable: !0,
      enumerable: !0,
      get: function () {
    ...
    F: {
      ...
      get: function () {
        var a = this.a.F.timestamp.maximum(this.b.F.timestamp),
          b = this.a.F.timestamp.equals(a)
            ? this.a.F.value
            : this.a.ra(a).value,
          c = this.b.F.timestamp.equals(a)
            ? this.b.F.value
            : this.b.ra(a).value;
        return { timestamp: a, value: [b, c] };
      },
  ...
  Dq.prototype.Z = function (a) {
    return a instanceof Dq ? this.input.Z(a.input) && this.od === a.od : !1;
  };
  Dq.prototype.ra = function (a) {
    a = this.input.ra(a);
    return { timestamp: a.timestamp, value: this.od(a.value) };
  };
  ea.Object.defineProperties(Dq.prototype, {
    active: {
      configurable: !0,
      enumerable: !0,
      get: function () {
  ...
  Fq.prototype.ra = function (a) {
    return {
      timestamp: a,
      value:
        this.F.value + (this.active ? Math.max(0, we(a, this.F.timestamp)) : 0),
    };
  };
  var Gq = function () {};
  ...
  Gq.prototype.map = function (a) {
    return new Hq(this, a);
  };
  Gq.prototype.ta = function (a) {
    return new Iq(this, a);
  };
  var Iq = function () {
    Cq.apply(this, arguments);
    this.map = Gq.prototype.map;
    this.ta = Gq.prototype.ta;
    this.ka = Gq.prototype.ka;
    this.sa = Gq.prototype.sa;
  };
  q(Iq, Cq);
  var Jq = function () {
  ...
  function Lq(a) {
    return J(
      hf(Kq, { totalTime: 0, qa: 0 }),
      N(function (b) {
        return new Jq(
          a,
          { timestamp: b.Ca.timestamp, value: b.totalTime },
          b.Ca.value
        );
      })
    );
  ...
  function Mq(a) {
    return J(
      ...
      N(function (b) {
        return new Jq(
          a,
          { timestamp: b.Ca.timestamp, value: b.qa },
          b.Ca.value
        );
      })
    );
  ...
  Oq.prototype.Z = function (a) {
    return a.active;
  };
  Oq.prototype.ra = function () {
    return this.F;
  };
  ...
  function Pq(a, b) {
    return b.g(
      N(function (c) {
        return new Oq(a.m, { timestamp: a.m.now(), value: c });
      })
    );
  }
  function Qq(a, b) {
    ...
    return function (b) {
      return b.g(
        ...
        N(function (c) {
          ...
          c = d.next().value;
          d = d.next().value;
          return { timestamp: c.timestamp, value: Qq(c.value, d) };
        })
      );
    };
  }
  ...
  var Yq = J(
    yq(
      N(function (a) {
        a = a.bd
          ? (a.L.width * a.L.height * a.bd) / (a.Y.width * a.Y.height)
          : (a.W.width * a.W.height) / (a.Y.width * a.Y.height);
        return isFinite(a) ? a : 0;
      })
    )
  );
  function Zq(a, b, c, d) {
    ...
    var x = Ad([h, b]).g(
      ...
      N(function (C) {
        ...
        C = da.next().value;
        da = da.next().value;
        return { visible: C.value, geometry: da.value.L };
      }),
      hf(
        function (C, da) {
  ...
  function $q(a, b, c) {
    return b.g(Xd(Ud), V(a, 1)).g(
      Q(function (d, e) {
        return Eq(d, e, kq);
      }),
      R({ timestamp: c.now(), value: jq }),
      V(a, 1)
    );
  }
  function cr(a, b, c, d) {
  ...
  var er = function (a) {
    ...
    gr = function (a, b) {
      fr(a);
      a.vd = a.m.setTimeout(function () {
        return void a.timeout.next();
      }, b);
    },
    fr = function (a) {
      a.vd !== null && (a.m.clearTimeout(a.vd), (a.vd = null));
    };
  function hr(a, b, c, d) {
    var e = ir.zg,
      f = new er(b);
      ...
      .g(
        N(function (g) {
          ...
          h.value >= e ||
            !k ||
            ((k = b.now()),
            (k = Math.max(0, we(k, h.timestamp))),
            gr(f, Math.max(0, e - h.value - k)));
          return g.map(function (l) {
            return l >= e;
          });
        })
      );
    return Ad([c, Td(f.timeout, M(void 0))]).g(
      N(function (g) {
  ...
  function jr(a) {
    var b = new Jq(a, { timestamp: a.now(), value: 0 }, !1);
    return J(
      Mq(a),
      hf(function (c, d) {
        return c.F.value > d.F.value ? new Jq(a, c.F, !1) : d;
      }, b),
      N(function (c) {
  ...
  function tr(a, b) {
    ...
    for (var c = Ob(a.l.children); c.length; ) {
      var d = b ? c.filter(qr) : c.filter(rr);
  ...
  function ur(a, b, c, d, e) {
    if (c) return { Xc: b, rb: M(null) };
    c = b.element.g(
      N(function (f) {
        a: if (f.l === void 0 || rr(f.l)) f = { pd: f, rb: "mue" };
        else {
          var g = tr(f, e);
          if (g.l !== void 0 && rr(g.l)) f = { pd: g, rb: "ie" };
          else {
            if (d || a.ke)
              if (
  ...
  function vr(a, b, c, d) {
    ...
    var x = Ad([h, b]).g(
      ...
      N(function (H) {
        ...
        H = C.next().value;
        C = C.next().value;
        return { visible: H.value, geometry: C.value.L };
      }),
      hf(
        function (H, C) {
  ...
  var Cr = {
    ...
    Dr = function (a, b) {
      ...
      (a = a.global.mraid)
        ? ((this.Wc = b(a)), (this.ua = a), (this.sb = c ? (d ? 2 : 1) : 0))
        : ((this.sb = -1), (this.Wc = 2));
    };
  Dr.prototype.addEventListener = function (a, b) {
    return this.Qb("addEventListener", a, b);
  };
  Dr.prototype.removeEventListener = function (a, b) {
    return this.Qb("removeEventListener", a, b);
  };
  Dr.prototype.Lf = function () {
    var a = this.Qb("getVersion");
    return typeof a === "string" ? a : "";
  };
  Dr.prototype.getState = function () {
  ...
  var Er = function (a) {
    ...
    Fr = function (a) {
      if (a.ua)
        return (a = a.ua.AFMA_LIDAR), typeof a === "string" ? a : void 0;
    };
  Dr.prototype.Si = function (a) {
    return a
      ? a.IS_GMA_SDK
        ? Object.values(Cr).every(function (b) {
  ...
  ea.Object.defineProperties(Dr.prototype, {
    uf: {
      configurable: !0,
      enumerable: !0,
      get: function () {
  ...
  function Gr(a, b) {
    return new Dr(a).sb !== -1
      ? new W(!0).T(a.i)
      : b.g(
          Yo("data-google-av-inapp"),
          N(function (c) {
            return c !== null;
          }),
          V(a.i, 1)
  ...
  var Ir = function (a, b) {
    ...
    Jr = function (a, b) {
      Hr(a);
      a.nd = a.m.setTimeout(function () {
        var c;
        return void ((c = a.xe) == null ? void 0 : c.next());
      }, b);
    },
    Hr = function (a) {
      a.nd !== null && a.m.clearTimeout(a.nd);
      a.nd = null;
    };
      ...
      var k = c
        ...
        .g(
          N(function (l) {
            ...
            r || !u
              ? Hr(g)
              : ((l = Math.max(0, we(b.now(), l))),
                Jr(g, Math.max(0, f - m - l)));
            return r;
          }),
          hf(function (l, m) {
            return m || l;
    ...
    return Qp([a, a.g(fq())]).g(
      N(function (b) {
        ...
        return {
          ...
          value: { visible: b.value, bb: c.value },
        };
      }),
      Q(function (b, c) {
        return Eq(b, c, function (d, e) {
  ...
  function Mr(a, b) {
    return {
      Kd: b.g(Yo("data-google-av-adk")),
      ac: b.g(
        Yo("data-google-av-btr"),
        Q(),
        N(function (c) {
          return c === null
            ? []
      ...
      hh: Dp(a, b),
      flags: b.g(Yo("data-google-av-flags"), Q()),
      kb: Gr(a, b),
      re: b.g(
        Up("cr", function (c) {
          return c === "1";
  ...
  var Vr = function (a, b, c, d, e, f) {
    this.rc = b.element.g(Ur(a), V(a.i, 1));
    this.ug = Pr(a, c, b.element, this.rc, d);
    c = Tr(a, b, e, d, this.ug, f);
    d = c.cc;
    this.Qa = c.Qa;
    this.cc = d;
    this.Ue = Td(
  ...
  function Yr(a) {
    var b = new ge(13);
    if (a.length < 1) return { chain: Hc, Pd: Hc };
    var c = new L(),
      d = a[0];
    return {
      chain: a
  ...
  function ds(a) {
    var b = Qo(a, !1);
    if (!a.ke || !Kg(a.global.parent) || a.global.parent === a.global) return b;
  ...
  es.prototype.Za = function (a, b) {
    var c = bs(cs(this.context, this.pb), lq(this.context, b.Sa));
    return { gb: Xr(a.Qa.g(c), b.kb, 0), Ya: {} };
  };
  ...
  fs.prototype.Za = function (a, b) {
    var c = this.Nh(b.Eg);
    return { gb: Xr(a.Qa.g(c, uq(this.context)), b.kb, 0), Ya: {} };
  };
  function gs(a, b, c, d, e) {
    var f = f === void 0 ? new Dr(a) : f;
    var g = g === void 0 ? qf(a.m, 500) : g;
    var h = h === void 0 ? qf(a.m, 100) : h;
    e = M(f).g(
      hs(c),
      lf(function (k) {
        d.next(k.sb);
    ...
    f = new L();
    b = Td(M({}), b, f);
    return e.g(ls(a, f, b, g, c), V(a.i, 1));
  }
  function ks(a, b) {
    return J(
      function (c) {
      ...
      We(function (c) {
        var d = y(c);
        c = d.next().value;
        return d.next().value !== 9 || Er(c)
          ? M(!0)
          : ms(a, c, "viewableChange").g(
              O(function (e) {
  ...
  function ls(a, b, c, d, e) {
    return T(function (f) {
      ...
      f.uf !== void 0 && (f.uf = !0);
      g = ms(a, f, g, ns);
      var h = { version: f.Lf(), sb: f.sb };
      g = g.g(
        N(function (l) {
          return os.apply(null, [a, b, f, h].concat(z(l)));
        })
      );
      var k = d.g(
        lf(function () {
      ...
      return Ad([g, c]).g(
        N(function (l) {
          l = y(l).next().value;
          return Object.assign({}, l, { timestamp: a.m.now() });
        })
      );
    });
  }
  ...
  function os(a, b, c, d, e, f) {
    ...
    a = {
      value: { ja: e, Y: c, fa: "mraid", da: b, pa: { x: 0, y: 0 } },
      timestamp: a.m.now(),
    };
  ...
  q(ps, Zr);
  ps.prototype.Za = function (a, b) {
    var c = new ed(1),
      d = new ed(1),
      e = bs(gs(this.context, this.pb, c, d, b.Sa), lq(this.context, b.Sa));
    return {
      gb: Xr(a.Qa.g(e), b.kb, 1),
      Ya: { ye: c.g(V(this.context.i, 1)), ze: d.g(V(this.context.i, 1)) },
    };
  };
  function qs(a) {
  ...
  function rs(a, b) {
    ...
    var d = new L(),
      ...
      g = d.g(
        N(function () {
          return e ? Object.assign({}, e, { timestamp: a.m.now() }) : null;
        }),
        O(function (k) {
          return k !== null;
        }),
      ...
      N(function (k) {
        ...
        try {
          var m = k.value.data,
            ...
            A = m.adView,
            P =
              A.measuringElement && A.containerGeometry
                ? ss(A.containerGeometry)
                : ss(A.geometry),
            S = ss(A.geometry),
            la = A.reasons.some(qs),
            H = la ? wi : ss(A.onScreenGeometry),
            C;
          ...
          var da, Cc;
          m =
            (Cc = (da = fc) == null ? void 0 : da.message) != null
              ? Cc
    ...
    return rs(b, c).g(
      ...
      N(function (d) {
        return {
          ...
          value: {
            pa: { x: d.value.L.left, y: d.value.L.top },
            ja: d.value.W,
            Y: d.value.Y,
            fa: d.value.U,
            da: d.value.da,
  ...
  q(vs, Zr);
  vs.prototype.Za = function (a, b) {
    var c = b.Sa;
    b = ts(this.P, this.na, this.pb, b.gg);
    c = bs(b, lq(this.P, c));
    return { gb: a.Qa.g(c), Ya: {} };
  };
  ...
  q(ws, Zr);
  ws.prototype.Za = function (a, b) {
    var c = ts(this.P, this.na, void 0, b.gg);
    b = tq(this.P, b.Eg, this.sh);
    c = bs(c, b);
    return { gb: a.Qa.g(c), Ya: {} };
  };
  function xs(a) {
  ...
  var As;
  As = ["2025110501"].slice(-1)[0].substring(0, 8);
  function Bs(a, b, c) {
    var d;
    return b.g(
      Q(),
  ...
  function Es(a, b, c) {
    var d = c.g(
      N(function (e) {
        return { value: e, timestamp: a.m.now() };
      }),
      Q(Eq)
    );
    return b instanceof K
      ? b.g(
          Q(),
          T(function (e) {
            return e ? new W({ value: !1, timestamp: a.m.now() }).T(a.i) : d;
          })
        )
      : b.value === !1
      ? d
  ...
  function Fs(a, b, c, d, e, f, g) {
    ...
    c = Es(a, c, d);
    a = g.Qa.g(Pp(a.i));
    return Object.assign({}, h, { dd: c, Gg: e, hf: k, eg: b, hd: a, Dg: f });
  }
  function Gs(a) {
    a = a.global;
  ...
  Is.prototype.evaluate = function () {
    ...
    if (b !== void 0 || this.te)
      this.te &&
        this.Ce.forEach(function (c) {
          return void c(a);
        }),
        b !== void 0 &&
          this.Be.forEach(function (c) {
            return void c(b);
          }),
        (this.Ce = []),
        (this.Be = []);
  };
  Is.prototype.then = function (a) {
    this.Ce.push(a);
    this.evaluate();
    return this;
  };
  Is.prototype.catch = function (a) {
    this.Be.push(a);
    this.evaluate();
    return this;
  };
  ...
  Ks.prototype.complete = function () {
    var a = this;
    this.qe = !0;
  ...
  Ks.prototype.onComplete = function (a) {
    this.qe ? a(this) : this.Qd.push(a);
  };
  Ks.prototype.ab = function (a) {
  ...
  Ms.prototype.clone = function () {
    var a = new Ms(this.mi, this.jd.description);
    a.jd = this.jd;
    return a;
  };
  Ms.prototype.ab = function (a) {
    return a !== this.event ? 2 : this.completed || this.Yd === 0 ? 0 : 1;
  };
  Ms.prototype.Pe = function (a, b) {
    this.ab(a) === 1 && (this.Yd--, b(), this.Yd === 0 && this.complete());
  };
  ea.Object.defineProperties(Ms.prototype, {
    event: {
      configurable: !0,
      enumerable: !0,
      get: function () {
  ...
  var Os = function (a, b, c) {
    ...
    e = y(e.values());
    for (var f = e.next(), g = {}; !f.done; g = { yf: void 0 }, f = e.next()) {
      g.yf = f.value;
      f = d.filter(
        (function (h) {
          return function (k) {
            return k.controlledEvents.indexOf(h.yf) >= 0;
          };
        })(g)
      );
      if (f.length === 0) throw Error("Ka");
      if (f.length > 1) throw Error("La");
    }
  };
  Os.prototype.start = function () {
    var a = this;
  ...
  var Ps = function (a, b) {
      ...
      b = {
        ...
        timestamp: we(a.context.m.now(), new ue(0, a.context.m.timeline)),
        mediatorState: b,
      };
      de(a.context, b);
    },
  ...
  Os.prototype.xh = function (a, b, c) {
    var d = this;
    if (!this.tc.has(a)) {
      var e = this.ph.clone();
      this.tc.add(a);
      ...
      this.Jb.forEach(function (h) {
        var k = function (l, m, u) {
          var r = d.context.fc.getName(a),
            t = we(d.context.m.now(), new ue(0, d.context.m.timeline)),
            w,
            v = (w = l.description) != null ? w : "n/a";
          if (h.controlledEvents.indexOf(l) < 0 || e.ab(l) !== 1)
            return (
              u(!1),
              Qs(d, r, t, v, 1),
              new Is(function (A) {
  ...
  var Ts = {
    considerOmidZOrderOcclusions: [new Rs("100006"), !1],
    extraPings: [new Ss("45362137"), 0],
    extrapolators: [new Rs("45377435"), !1],
    rxlidarStatefulBeacons: [new Rs("45372163"), !1],
    shouldIgnoreAdChoicesIcon: [new Rs("45382077"), !1],
    dedicatedViewableAttributionPing: [new Ss("45389692"), 0],
    useReachIntegrationPolyfill: [new Rs("45407239"), !1],
    useReachIntegrationSharedStorage: [new Rs("45407240", !0), !0],
    sendBrowserIdInsteadOfVPID: [new Rs("45407241"), !1],
    waitForImpressionColleague: [new Rs("45430682"), !1],
    fetchLaterBeacons: [new Rs("45618478"), !1],
    rxInNonrx: [new Rs("45642405"), !1],
    addQueryIdToErrorPing: [new Rs("45653435"), !1],
    shouldSendExplicitDisplayMeasurablePing: [new Rs("45658589"), !1],
    reachUseCreateWorklet: [new Rs("45661569"), !1],
    tosCustomTimeoutMillis: [new Ss("45706257", 36e5), 36e5],
    shouldCacheTimeMetricsInLocalStorage: [new Rs("45722991"), !1],
  };
  function Us(a) {
    return Object.entries(Ts).reduce(function (b, c) {
      var d = y(c);
      c = d.next().value;
  ...
  Ys.prototype.O = to(at);
  var bt = [0, fo, -1, eo, at, bo, -1, lo, ao, eo, ao];
  $s.prototype.O = to(bt);
  var ct = function (a) {
    ro.call(this, a);
  };
  q(ct, ro);
  ct.prototype.Gf = function () {
    return en(this, 1);
  };
  ct.prototype.Hf = function () {
    return sl(Im(this, 1));
  };
  ct.prototype.ed = function () {
    return dn(this, 2);
  };
  ct.V =
    "ads.branding.measurement.client.serving.integrations.shared.SharedMetadata";
  var dt = [0, fo, ao];
  ct.prototype.O = to(dt);
  var et = function (a) {
    ro.call(this, a);
  };
  q(et, ro);
  ...
  et.V = "ads.branding.measurement.client.serving.IntegratorMetadata";
  var gt = [0, bt, Xs, dt];
  et.prototype.O = to(gt);
  var ht = so(et, gt);
  var jt = function () {
    this.Bf = {};
  };
        ...
        c
          ...
          : d.g(
              N(function (g) {
                ...
                return Object.freeze({ tb: h, element: new W(g).T(f.i) });
              }),
              $o()
            )
  ...
  lt.V = "contentads.bow.rendering.client.TurtleDoveReportingData";
  lt.prototype.O = to([0, fo, ao, fo, -5, ko, fo, -4]);
  function nt() {
    var a = Pg();
    return a
      ? Mb(
  ...
  var ir = Object.freeze({ zg: 1e3, Zd: 0.5, ve: 0.3 }),
    pr = Object.freeze([1, 0.75, ir.Zd, ir.ve, 0]),
  ...
  n.he = function (a, b, c, d, e) {
    if (!Mm(b, Xm, 2) || Zm(b, Xm, 2).de()) {
      this.Wd.next(
        Object.assign({}, this.pi.qf.get(a), {
          metadata: b,
          experimentState: c,
          ik: a,
          Oa: d,
      ...
      var f, g;
      e((g = (f = Zm(b, Xm, 2)) == null ? void 0 : f.ed()) != null ? g : -1);
    }
  };
  n.Cb = function () {};
  ...
  function pt(a, b, c, d, e, f, g, h, k, l, m) {
    var u = zs(a).g(
        N(function (t) {
          return !t;
        })
    ...
    return kp(
      ...
      function (t, w) {
        ...
        v = v.ue;
        var wg,
          kb = (wg = Vs(Ym(w.metadata))) != null ? wg : "";
        wg = mt(new lt(), atob(kb)).Ta();
        kb = new W(w.experimentState).T(t.i);
        var on = new W(new sf(t, new Hg(t))),
          pn = kb.g(
            N(function (E) {
          ...
          Na = H.g(
            ...
            N(function (E) {
              ...
              (E = E || lb) ||
                ((E =
                  (ab(Pg(), "CrKey") &&
                    !(ab(Pg(), "CrKey") && ab(Pg(), "SmartSpeaker"))) ||
                  ab(Pg(), "PlayStation") ||
                  ab(Pg(), "Roku") ||
                  nt() ||
                  ab(Pg(), "Xbox")) ||
                ...
                E ||
                  ((E = Pg()),
                  (E = ab(E, "sdk_google_atv_x86") || ab(E, "Android TV"))));
              return E;
            })
          );
        C = new Vr(t, w, la, H, fc, Ce);
        Ce = kb.g(
          N(function (E) {
        ...
        var Ec,
          Ab = (Ec = Ws(Ym(w.metadata))) != null ? Ec : !1;
        Ec = r.Za(C, { kb: H, Eg: Ab, Sa: fc, gg: Ce });
        var $a = Ec.gb,
          De = Ec.Ya;
        Ec = De.ye;
        Ce = De.ze;
        De = De.Me;
        Ab = new W(Ab).T(t.i);
        var jc = Fs(t, Cc, Na, u, Ma, Ab, C);
        Ma = vr(t.i, t.m, $a, jc);
        Na = Ds(t.i, Ma.xa.Oe, Ma.xa.visible, Ma.Ke, Ma.Hc);
        Ab = Kr(t.i, t.m, Ma.Hc, Ma.xa.da, Ma.xa.visible);
        $a = Zq(t.i, t.m, $a, jc);
        jc = or(t.m, t.i, $a.xa.Oe, $a.xa.visible, $a.Ke, $a.Hc);
        var Ni = { Se: hr(t.i, t.m, $a.Hc, jc.uc) },
          Oi = kb.g(
            N(function (E) {
        ...
        jc = qt(t, C, x);
        Ni = rt(t, Na, w.element);
        Oi = jc.Tg.g(R({ x: 0, y: 0 }));
        var du = kb.g(
            N(function (E) {
          ...
          fu = b.g(
            N(function (E) {
              var lb;
              return E.experimentState.addQueryIdToErrorPing
                ? (lb = Zm(E.metadata, ct, 3)) == null
                  ? void 0
                  : lb.Hf()
                : void 0;
            })
        ...
        return Object.assign(
          {},
          {
            ...
            ac: A.g(R([]), V(t.i, 1)),
            Hj: kb,
            shouldSendExplicitDisplayMeasurablePing: kb.g(
              N(function (E) {
  ...
  function qt(a, b, c) {
    ...
    d =
      ((e = d.performance) == null
        ...
        ? void 0
        : f.navigationStart) || 0;
    return Object.assign({}, { Rg: new W(d), Qg: cq(a, b) }, bq(a, b, c));
  }
  function rt(a, b, c) {
    return b.g(
      O(function (d) {
  ...
  n.he = function (a, b, c, d) {
    if ((b = this.Na)) (c = new tt(b, c, this.Eb, d)), this.je.set(a, c);
  };
  n.Cb = function (a) {
    this.je.delete(a);
  };
  ...
  tt.prototype.init = function (a) {
    var b = this;
    this.zc = a.global.document;
    this.Sf.push(ut(this));
    var c = {};
    this.Rf = Js(this.Sf);
    this.Rf.then(function () {
      b.Qf = "&vis=" + xs(b.zc) + "&uach=0&ms=0";
      c.paramString = b.Qf;
  ...
  function wt(a, b) {
    b =
      ...
      encodeURIComponent(Uh(b.O()));
    a.J.K(b, { ia: "GET" }).sendNow();
  }
  function xt(a) {
    return [
      {
        ...
        Fc: !1,
        dc: !0,
        filterIds: yt(a == null ? void 0 : a.productionFilterIds),
      },
      {
        Ab: 2,
        Fc: !0,
        dc: !0,
        filterIds: yt(a == null ? void 0 : a.testFilterIds),
      },
      {
        Ab: 2,
        Fc: !1,
  ...
  zt.prototype.If = function () {
    return Zm(this, Ys, 11);
  };
  zt.prototype.rg = function (a) {
    return bn(this, Ys, 11, a);
  };
  zt.V =
    "ads.branding.measurement.client.frontend.integrations.reach.ReachStatusMessage";
  zt.prototype.O = to([0, ko, fo, -1, ko, -2, fo, -1, ao, fo, at, lo, ao]);
  var Dt = function (a) {
      this.context = a;
      this.points = [];
    },
  ...
  function Gt(a, b) {
    ...
    Ht === void 0 && (Ht = Oa.Int32Array ? new Int32Array(It) : It);
    this.reset();
  }
  Ua(Gt, Ft);
  for (var Jt = [], Kt = 0; Kt < 63; Kt++) Jt[Kt] = 0;
  var Lt = [].concat(128, Jt);
  ...
  var Mt = function (a) {
    ...
    for (var c = a.Ui, d = 0, e = 0; e < b.length; )
  ...
  Gt.prototype.update = function (a, b) {
    b === void 0 && (b = a.length);
    var c = 0,
      d = this.Fb;
    if (typeof a === "string")
      for (; c < b; )
        (this.Vc[d++] = a.charCodeAt(c++)),
          d == this.blockSize && (Mt(this), (d = 0));
    else if (Ra(a))
      for (; c < b; ) {
        var e = a[c++];
  ...
  Gt.prototype.digest = function () {
    var a = [],
      b = this.zd * 8;
    this.Fb < 56
      ? this.update(Lt, 56 - this.Fb)
      : this.update(Lt, this.blockSize - (this.Fb - 56));
  ...
  Pt.prototype.Kf = function () {
    return Pm(this, 8, kl, void 0 === Qk ? 2 : 4);
  };
  Pt.prototype.ff = function (a) {
    return kn(this, 8, a);
  };
  Pt.prototype.sg = function (a) {
    return fn(this, 9, a);
  };
  Pt.V =
    "ads.branding.measurement.client.frontend.integrations.reach.ContextIdMessage";
  var Qt = [0, Yn, co, -1];
  oo.prototype.O = to(Qt);
  Pt.prototype.O = to([0, Qt, eo, -1, io, -3, mo, eo]);
  var no = function (a) {
    ro.call(this, a, 1);
  };
  q(no, ro);
  no.V = "proto2.bridge.MessageSet";
  var Rt = {};
  no[Rk] = Rt;
  var St = so(oo, Qt);
  Rt[4156379] = { Kj: new po() };
  var Tt = function () {
    var a;
    this.message = a = a === void 0 ? new Pt() : a;
  };
  Tt.prototype.Gc = function (a) {
    var b = this.message;
    a = St(Wh(a));
    this.message = bn(b, oo, 1, a);
    return this;
  };
  var Ut = function (a, b) {
    var c = fn(a.message, 2, b.Ab === 2);
    b = fn(c, 3, !b.Fc);
    a.message = b;
    return a;
  };
  Tt.prototype.Sb = function (a) {
    this.message = this.message.Sb(Math.max(1, a));
    return this;
  };
  var Vt = function (a, b) {
      a.message = a.message.ff(b);
      return a;
    },
    Wt = function (a) {
      var b = As.match(/m\d{12}/g),
        c = As.match(/\d{8}/g);
      if (b && b.length > 0) {
        b = b[0].slice(1);
        c = a.message;
  ...
  Tt.prototype.encode = function () {
    var a = this.message,
      b = Uh(a.O());
    b.length > 64 && ((a = a.Sb(1)), (b = Uh(a.O())));
    b.length > 64 && ((a = Km(a, 6)), (b = Uh(a.O())));
    b.length > 64 && ((a = Km(a, 7)), (b = Uh(a.O())));
    b.length > 64 && ((a = Km(a, 5)), (b = Uh(a.O())));
    return b;
  };
  function Xt(a, b) {
    ...
    a = $t([
      [
        ...
        cu(
          a.map(function (b) {
            return $t([
              [Zt("value"), [68].concat(z(gu(BigInt(b.value), 4)))],
              [Zt("bucket"), [80].concat(z(gu(b.bucket, 16)))],
              [Zt("filteringId"), [68].concat(z(gu(b.filteringId, 4)))],
            ]);
          })
        ),
      ],
      [Zt("operation"), Zt("histogram")],
    ]);
    return btoa(String.fromCharCode.apply(String, z(new Uint8Array(a))));
  }
  var ju = {},
    ku = ((ju[2] = "prod"), (ju[1] = "canary"), ju);
  function lu(a, b, c, d) {
    var e, f, g, h, k, l, m, u;
      ...
      switch (r.u) {
        case 1:
          ...
          if (g instanceof Error)
            return (
              f(-16),
              (h = Ct(Bt(At(new zt(), 8), g.name), g.message)),
              wt(a, h),
              r.return()
            );
          d.points.push(7);
          ...
          return va(
            r,
            c.experimentState.reachUseCreateWorklet ? nu(a, b, f) : ou(a, b, f),
            2
          );
        case 2:
          ...
          return (
            ...
            (u = e.map(function (t) {
              ...
              return pu(
                ...
                c.escapedQueryId,
                (v = c.trafficTypes) != null ? v : [0],
                (x = c.isProductSplitVpidLogsExperiment) != null ? x : !1,
                function (A) {
                  var P,
                    S = Wt(
                      Ut(
    ...
    return Ha(function (g) {
      switch (g.u) {
        ...
        case 2:
          (e = xa(g)),
            c(-17),
            (f = Ct(Bt(At(new zt(), 1), e.name), e.message)),
            wt(a, f);
        case 3:
          return g.return(d);
      }
  ...
  function nu(a, b, c) {
    ...
    return Ha(function (g) {
      if (g.u == 1) {
        ...
        if (!d) return g.return(Promise.reject(Error("Ra")));
        wa(g, 2);
        return va(g, d.createWorklet(b, { dataOrigin: "script-origin" }), 4);
      }
      ...
      switch (r.u) {
        case 1:
          return (
            ...
            (h = { method: "GET" }),
            (k = 200),
            (l = b.geoTargetMessage ? Zs(b.geoTargetMessage) : void 0),
            (m = new zt().Gc(b.escapedQueryId).rg(l)),
            wa(r, 2),
            va(r, a.global.fetch(ru(c, e), h), 4)
          );
        case 4:
          f = r.ba;
          k = f.status;
        ...
        case 2:
          (u = xa(r)),
            (k = -1),
            u instanceof Error && Ct(Bt(m, u.name), u.message);
        case 3:
          var t = At(m, 2);
          Km(t, 9, k == null ? k : ml(k));
          if (!f || !f.ok)
            return (
              (t = jn(m, 4, 4)),
              (t = hn(t, 8, e)),
  ...
  function ru(a, b) {
    return "https://www.googletagservices.com/agrp/" + ku[a] + "/" + b;
  }
  function pu(a, b, c, d, e, f, g, h, k) {
    var l, m, u, r, t, w, v;
      ...
      switch (x.u) {
        case 1:
          ...
          if (A === void 0) A = -1;
            ...
            S = BigInt(0);
            la = y(la);
            for (var H = la.next(); !H.done; H = la.next())
              S = (S * BigInt(256) + BigInt(H.value)) % A;
            A = P(S);
          }
          m = A;
          A = Wt(Ut(Vt(new Tt().Gc(f), g), c).Sb(m));
        ...
        case 3:
          (v = xa(x)),
            ...
            (la = Ct(
              Bt(
                At(new zt(), 3),
                (P = A == null ? void 0 : A.name) != null ? P : "unknown"
              ),
              (S = A == null ? void 0 : A.message) != null ? S : ""
            )),
            wt(a, la);
        case 2:
          (A = At(new zt(), 5)),
    ...
    if (g) {
      ...
      Et(h, function () {
        ...
        return Ha(function (r) {
          if (r.u == 1) {
            h.points.push(1);
            if (Mm(b, $s, 1) && !ft(b).de()) return r.return();
            h.points.push(2);
            return No(g) ? va(r, jd(vt(g)), 2) : r.return();
          }
          if (r.u != 3) {
            k = r.ba;
            if (!k) return r.return();
            h.points.push(3);
            l = new tu(g, b, f.De, c, d, h);
            f.Bc.set(a, l);
            return va(r, l.run(), 3);
          }
          e((u = (m = ft(b)) == null ? void 0 : m.ed()) != null ? u : -1);
          r.u = 0;
        });
      });
    }
  ...
  var uu = function (a) {
      ...
      return Ha(function (S) {
        var la = a.experimentState,
          H =
            (l = (b = ft(a.metadata)) == null ? void 0 : b.Gf()) != null
              ? l
              : "",
          C =
            (m = (c = ft(a.metadata)) == null ? void 0 : c.Kf()) != null
              ? m
              : void 0,
          da = (d = ft(a.metadata)) == null ? void 0 : sl(Im(d, 1)),
          Cc =
            (u =
              (e = ft(a.metadata)) == null
                ? void 0
                : (f = e.If()) == null
                ? void 0
                : f.Ta()) != null
              ...
              : void 0,
          fc =
            (r = (g = ft(a.metadata)) == null ? void 0 : dn(g, 8)) != null
              ? r
              : void 0,
          pd = vu;
        var Ma =
          (h = ft(a.metadata)) == null
            ? void 0
            : Pm(h, 5, nl, Qk === Qk ? 2 : 4);
        pd = pd(a, (t = Ma) != null ? t : void 0);
        Ma = vu;
        var vg =
          (k = ft(a.metadata)) == null
            ? void 0
            : Pm(k, 6, nl, Qk === Qk ? 2 : 4);
        v = {
          experimentState: la,
          ...
          geoTargetMessage: Cc,
          deviceType: fc,
          productionFilterIds: pd,
          testFilterIds: Ma(a, (w = vg) != null ? w : void 0),
        };
        if (a.experimentState.reachUseCreateWorklet)
          return (
            (P = a.context.Le[2]),
            a.Sd.points.push(10),
            va(S, lu(a.context, P, v, a.Sd), 0)
          );
        x = a.context.Le[0];
        A = btoa(JSON.stringify(v));
        return va(S, vi(a.context.document, x, A), 0);
      });
    },
    vu = function (a, b) {
      if (b !== void 0)
  ...
  var wu = Jf(
      "m202511050101".match(/^m\d{10}$/g) !== null ? "m202511050101" : "current"
    ),
    xu;
  a: {
    try {
      var yu = new mg();
      xu = new Lf(yu, "doubleclickbygoogle.com-omid", void 0, wu);
      break a;
    } catch (a) {}
    xu = void 0;
  }
  var zu = xu,
    Au = { P: new Mo(void 0, void 0, void 0, wu), na: zu };
  (function (a) {
    if (a && Bg(a)) {
      var b = Ag(a);
      if (b) {
  ...
  (function (a, b, c) {
    var d = new Ns("impression"),
      e = new Ns("begin to render"),
      f = new Ns("unmeasurable"),
      g = new Ns("viewable"),
      h = new Ns("reach vpid"),
      k = new Ls(d, h, e, g, f),
      l = new kt(),
      m = new st(d.event);
    b = new ot(l, c, d.event, e.event, f.event, g.event, b);
    h = new su(h.event);
    var u = new Os(a, k, l, m, b, h);
    u.start();
    return {
      dispose: function () {
        return void u.dispose();
      },
      colleagues: { Fj: m, gk: b, ck: h },
    };
  })(Au, 7);
}.call(this));
