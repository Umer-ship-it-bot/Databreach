...
*/
  ...
  var bb = ab("jas", void 0, !0),
    ...
    gb = ab(void 0, "0actk"),
    hb = ab("m_m", "Kb", !0);
  var ib = { eb: { value: 0, configurable: !0, writable: !0, enumerable: !1 } },
  ...
  function pc(a, b, c, d) {
    ...
    if (!Array.isArray(a))
      return c ? (d & 2 ? b[eb] || (b[eb] = qc(b)) : new b()) : void 0;
    c = a[F] | 0;
    d = c | (d & 32) | (d & 2);
    d !== c && G(a, d);
    return new b(a);
  ...
  function xc() {
    ...
    if (gb != null) {
      ...
      a = b[gb] || 0;
      a >= 5 ||
        ((b[gb] = a + 1), (b = Error()), Ua(b, "incident"), Wa ? Ya(b) : za(b));
    }
  }
  function yc(a, b) {
  ...
  function Sc(a) {
    ...
    b = new u.Map();
    Object.defineProperty(a, fb, { value: b });
    return b;
  }
  function Uc(a, b, c, d) {
    var e = Sc(a),
...
*/
  ...
  var Nd = Ad(function () {
    return (
      Da && Fa
        ? Fa.mobile
        : !Bd() && (E("iPod") || E("iPhone") || E("Android") || E("IEMobile"))
    )
      ? 2
      : Bd()
      ? 1
  ...
  function Sd() {
    try {
      return (
        Qd != null || (Qd = new Uint32Array(64)),
        Rd >= 64 && (crypto.getRandomValues(Qd), (Rd = 0)),
        Qd[Rd++]
      );
    } catch (a) {
  ...
  function Ud(a, b) {
    ...
    (b == null ? void 0 : b.attributionSrc) !== void 0 &&
      (a += ' attributionsrc="' + Vd(b.attributionSrc) + '"');
  ...
  var ve = function (a) {
      try {
        ...
        b.publisherCC =
          String.fromCharCode(ke + V(c, 6)) + String.fromCharCode(ke + V(c, 6));
        b.vendor = {
  ...
  function Ae(a, b) {
    ...
    c.fetch
      ? ((b = {
        ...
        c.fetch(a, b))
      : ye(c, a, b === void 0 ? !1 : b, d === void 0 ? !1 : d);
  }
  function Be(a, b) {
    try {
      var c = function (d) {
  ...
  function Ce(a, b) {
    try {
      ...
      ze({ m: d, b: T(b, 1) || null, v: S(b, 2) || null });
    } catch (g) {}
  }
  ...
  Ef.prototype.J = function (a) {
    this.g.o(
      Ne(Oe(Me("av7Wxb"), He(new Fe(), a.Ma)), Ke(new Ie(), Math.round(a.K)))
    );
  };
  var Ff = function (a) {
    this.g = a;
  ...
  Ff.prototype.J = function (a) {
    this.g.o(
      Ne(
        Oe(Oe(Me("JwITQ"), He(new Fe(), a.oa)), He(new Fe(), a.qa)),
        Ke(new Ie(), Math.round(a.K))
      )
    );
  };
  var Gf = function (a) {
  ...
  Gf.prototype.J = function (a) {
    this.g.o(
      Ne(
        Oe(Oe(Me("Pn3Upd"), He(new Fe(), a.oa)), He(new Fe(), a.qa)),
        Ke(new Ie(), Math.round(a.K))
      )
    );
  };
  ...
  Lf.prototype.l = function () {
    var a = qa.apply(0, arguments),
      b = this;
    try {
      this.V && Be(this.g.concat(a), Ee(this)).length >= 65536 && Mf(this),
        this.L &&
          !this.O &&
          ((this.O = !0),
          this.L.g(function () {
        ...
        this.g.push.apply(this.g, B(a)),
        this.g.length >= this.U && Mf(this),
        this.g.length &&
          this.j === null &&
  ...
  var tg = function (a) {
      ...
      this.l =
        b && c
          ...
          : null;
      this.tcString =
        (c = cg(a.document)) && oc(M(c, 1)) != null ? S(c, 1) : null;
    ...
    sg = function (a) {
      ...
      return c === -1 || c >= d.length
        ? null
        : { uspString: ng(d[c], gd(a, 1)), la: pe(xg(a)) };
    },
    xg = function (a) {
  ...
  function Ag(a, b, c) {
    try {
      ...
      if (
        ...
        if (b instanceof Ed)
          (d.href = Gd(b).toString()), (d.rel = "compression-dictionary");
        else {
          if (Ld.indexOf("compression-dictionary") === -1)
            throw Error(
  ...
  function Wg(a, b, c, d) {
    var e = (d = d === void 0 ? 0 : d),
      ...
      g;
    W(Xg).l[e] =
      (g = (f = W(Xg).l[e]) == null ? void 0 : f.add(b)) != null
        ? g
        : new u.Set().add(b);
    e = Vg();
    ...
    for (var h = b.next(); !h.done; h = b.next()) {
      ...
      for (var k = Yg(h), m = y(a), n = m.next(); !n.done; n = m.next()) {
        ...
        if (p) {
          ...
          if ((r = A))
            (t = void 0), (r = !((t = W(Xg).l[h]) == null || !t.has(p)));
          r && f.push(A);
          if (l === 8 && k[p])
            (A = Kg(JSON.stringify(k[p]))),
              (l = Yc(n, Gg, 4)),
              (A = Hg(Zc(A, Gg, 4))),
              ed(l, A);
          else {
            if ((l = A))
              (r = void 0), (l = !((r = W(Xg).g.get(h)) == null || !r.has(p)));
            l && g.push(A);
          }
          e ||
            ((l = p),
            ...
            t.g.get(A).has(l) || t.g.get(A).set(l, []),
            r && t.g.get(A).get(l).push(r));
          k[p] = K(n);
        }
      }
    }
  ...
  function Eh(a, b) {
    ...
    for (d = b.next(); !d.done; d = b.next())
      for (
        d = d.value, e = R(d, yh, 2, P()), e = y(e), f = e.next();
        !f.done;
        f = e.next()
      )
        ...
        for (
          ...
          if (p.length)
            ...
            var z = void 0,
              A = void 0;
            p =
              (A = (z = p) == null ? void 0 : z(String(r))) != null
                ? A
                : m === 2 && T(t[0].ia, 11) === 1
                ? void 0
                : d[0](String(r));
                ...
                if (((t = t.value), t.ca === b)) {
                  ...
                  z < 0 ||
                    ...
                    z !== 0 &&
                      z !== void 0 &&
                      ((A = a.l[String(z)]),
                      A !== void 0 && A !== t.F.getId()
                        ? Pg(a.u, a.l[String(z)], t.F.getId(), z)
    ...
    Oh = function (a, b) {
      ...
      return c.success
        ? c.value
          ? !0
          : !1
        : (Qg(a.u, Q(b.F, ff, 3), b.ca, b.F.getId(), c), !1);
    },
    Rh = function (a, b) {
      b = b
        .map(function (c) {
  ...
  function di(a) {
    ...
    var g =
      a.u === void 0
        ? new Mg(
            (ai = pg((Yh = Q(b, Bh, 5)) == null ? void 0 : id(Yh, 2))) != null
              ? ai
              : 0,
            (bi = pg((Zh = Q(b, Bh, 5)) == null ? void 0 : id(Zh, 4))) != null
              ? bi
              : 0,
            (ci = ($h = Q(b, Bh, 5)) == null ? void 0 : fd($h, 3)) != null
              ? ci
              : !1
          )
        : a.u;
    ...
    e.hasOwnProperty("init-done")
      ? (Y(12, e, function () {})(
          R(b, Ah, 2, P()).map(function (h) {
            return K(h);
          })
        ),
        Y(13, e, function () {})(
          R(b, Jg, 1, P()).map(function (h) {
            return K(h);
          }),
          f
        ),
  ...
  function ri(a, b) {
    return qi(a, b, function (c, d) {
      ...
      Math.random() > f ||
        ((d.error && d.meta && d.id) || (d = new xe(d, { context: c, id: g })),
        ...
        Ti(
          Qi(
            Xi(
              Si(
                Yi(
                  Ui(Ri(new Pi(), a.architecture || ""), a.bitness || ""),
                  a.mobile || !1
                ),
                a.model || ""
              ),
    ...
    return (
      (k[3] =
        ...
        (a[59] = function () {
          ...
          r =
            (t =
              (p = Hh(r.location.href.match(Gh)[3] || null)) == null
                ? void 0
                : p.split(".")) != null
              ? t
              : [];
          p =
            r.length < 2
              ...
              ? r.length < 3
                ? null
                : Kh(r.splice(r.length - 3).join("."))
              : Kh(r.splice(r.length - 2).join("."));
          return n.call(m, l(p));
        }),
        (a[74] = function () {
          return v(qa.apply(0, arguments), "includes").call(
            qa.apply(0, arguments),
            String(Kh(window.location.href))
          );
        }),
        (a[61] = function () {
          return e;
  ...
  function sj(a) {
    return (
      !(a == null || !a.src) &&
      Hh(a.src.match(Gh)[3] || null) === "pagead2.googlesyndication.com"
    );
  }
  var tj = oa([
  ...
  function vj(a) {
    a = sj(a) ? Wd(tj, "m202511120101") : Wd(uj, "m202511120101");
    var b = Uh(Vf);
    return b ? Xd(a, new u.Map([["cb", b]])) : a;
  }
  function wj(a, b) {
    var c = nj(246);
    c = vc(c);
    ...
    !R(c, Ah, 2, P()).length &&
      R(a, Ah, 2, P()).length &&
      ((d = R(a, Ah, 2, P())), dd(c, 2, d));
    !Kc(c, Bh, 5) && Kc(a, Bh, 5) && ((a = Q(a, Bh, 5)), bd(c, 5, a));
    oj(246, K(c));
    di({ Ya: c, A: qj(b), Fa: 2, config: { pa: b.pa } });
    b.Ra.forEach(oh);
  }
  ...
  function Aj(a, b, c, d, e) {
    ...
    a
      ? ((c = c ? Wd(yj) : Wd(zj)), (c = Xd(c, a)), Bj(c, d, e))
  ...
  function Jj(a, b) {
    try {
      ...
      return b.G({ methodName: 838, I: g }), Ij();
    }
  }
  function Kj() {
    var a;
  ...
  function Mj() {
    var a = sttc,
      ...
      e = b.fa;
    if (fetch) {
      ji(c.P, 1e3) && d.ga.ja.ea.Ia.J({ K: 1e3, Ma: !0 });
      Xa(function (A) {
        e.G({ methodName: 1189, I: A });
      });
      b = Kj();
      a = Jj(a, e);
      vb(!W(mj).g);
      ...
      Lj("cmd", []);
      var n,
        l = (n = Oj(m)) != null ? n : Pj(m);
      Qj(f, k, v(Object, "assign").call(Object, {}, { La: l }, g));
      try {
        Gi();
      } catch (A) {}
      pi("1", k);
      ...
      if (!Rj(m)) {
        ...
        try {
          Md(
            m,
            Ud(n, { id: g, nonce: Jd(document), Ha: f ? "anonymous" : void 0 })
          );
        } catch (A) {}
